  ...
  return (
    <div className='space-y-7 pb-12'>
      ...
      <header>
        ...
        <h1 className='text-xl font-bold tracking-tight text-foreground md:text-2xl'>{t('boardOversight.title')}</h1>
        <p className='mt-2 max-w-3xl text-xs leading-relaxed text-muted-foreground'>{t('boardOversight.subtitle')}</p>
      </header>
