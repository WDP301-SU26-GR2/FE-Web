 ...
 */
import type { DefenseDashboardResDtoOutputTankobonVolumesItem } from './defenseDashboardResDtoOutputTankobonVolumesItem';

export type DefenseDashboardResDtoOutputTankobon = {
  /**
   * @minimum -9007199254740991
   * @maximum 9007199254740991
   */
  totalUnitsSold: number;
  volumes: DefenseDashboardResDtoOutputTankobonVolumesItem[];
};
