 ...
 */
export type DefenseDashboardResDtoOutputRankingTrendItemRiskLevel = typeof DefenseDashboardResDtoOutputRankingTrendItemRiskLevel[keyof typeof DefenseDashboardResDtoOutputRankingTrendItemRiskLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DefenseDashboardResDtoOutputRankingTrendItemRiskLevel = {
  NONE: 'NONE',
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  SEVERE: 'SEVERE',
