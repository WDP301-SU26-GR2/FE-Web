 ...
 */
import type { MagazineListResDtoOutputItemsItemPublicationTypesItem } from './magazineListResDtoOutputItemsItemPublicationTypesItem';

export type MagazineListResDtoOutputItemsItem = {
  name: string;
  publicationTypes: MagazineListResDtoOutputItemsItemPublicationTypesItem[];
};
