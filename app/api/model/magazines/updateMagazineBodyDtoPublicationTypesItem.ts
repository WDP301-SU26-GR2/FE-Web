 ...
 */
export type UpdateMagazineBodyDtoPublicationTypesItem = typeof UpdateMagazineBodyDtoPublicationTypesItem[keyof typeof UpdateMagazineBodyDtoPublicationTypesItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateMagazineBodyDtoPublicationTypesItem = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
