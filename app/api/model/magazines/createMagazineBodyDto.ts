 ...
 */
import type { CreateMagazineBodyDtoPublicationTypesItem } from './createMagazineBodyDtoPublicationTypesItem';

export interface CreateMagazineBodyDto {
  /**
   * @minLength 1
   * @maxLength 100
   */
  name: string;
  /** @minItems 1 */
  publicationTypes: CreateMagazineBodyDtoPublicationTypesItem[];
}
