 ...
 */
export type MagazineListResDtoOutputItemsItemPublicationTypesItem = typeof MagazineListResDtoOutputItemsItemPublicationTypesItem[keyof typeof MagazineListResDtoOutputItemsItemPublicationTypesItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MagazineListResDtoOutputItemsItemPublicationTypesItem = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
