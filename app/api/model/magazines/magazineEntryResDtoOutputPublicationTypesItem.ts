 ...
 */
export type MagazineEntryResDtoOutputPublicationTypesItem = typeof MagazineEntryResDtoOutputPublicationTypesItem[keyof typeof MagazineEntryResDtoOutputPublicationTypesItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MagazineEntryResDtoOutputPublicationTypesItem = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
