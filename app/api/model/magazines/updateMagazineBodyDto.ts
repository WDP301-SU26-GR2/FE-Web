 ...
 */
import type { UpdateMagazineBodyDtoPublicationTypesItem } from './updateMagazineBodyDtoPublicationTypesItem';

export interface UpdateMagazineBodyDto {
  /** @minItems 1 */
  publicationTypes: UpdateMagazineBodyDtoPublicationTypesItem[];
}
