 ...
 */
import type { MagazineEntryResDtoOutputPublicationTypesItem } from './magazineEntryResDtoOutputPublicationTypesItem';

export interface MagazineEntryResDtoOutput {
  name: string;
  publicationTypes: MagazineEntryResDtoOutputPublicationTypesItem[];
}
