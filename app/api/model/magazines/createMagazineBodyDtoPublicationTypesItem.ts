 ...
 */
export type CreateMagazineBodyDtoPublicationTypesItem = typeof CreateMagazineBodyDtoPublicationTypesItem[keyof typeof CreateMagazineBodyDtoPublicationTypesItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateMagazineBodyDtoPublicationTypesItem = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
