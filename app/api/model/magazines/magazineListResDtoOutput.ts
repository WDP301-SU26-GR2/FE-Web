 ...
 */
import type { MagazineListResDtoOutputItemsItem } from './magazineListResDtoOutputItemsItem';

export interface MagazineListResDtoOutput {
  items: MagazineListResDtoOutputItemsItem[];
}
