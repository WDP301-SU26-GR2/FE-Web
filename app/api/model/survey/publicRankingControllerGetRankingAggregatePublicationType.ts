...
export type PublicRankingControllerGetRankingAggregatePublicationType = typeof PublicRankingControllerGetRankingAggregatePublicationType[keyof typeof PublicRankingControllerGetRankingAggregatePublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicRankingControllerGetRankingAggregatePublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
