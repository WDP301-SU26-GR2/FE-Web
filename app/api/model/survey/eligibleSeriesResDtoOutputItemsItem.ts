 ...
 */
import type { EligibleSeriesResDtoOutputItemsItemStatus } from './eligibleSeriesResDtoOutputItemsItemStatus';
import type { EligibleSeriesResDtoOutputItemsItemPublicationType } from './eligibleSeriesResDtoOutputItemsItemPublicationType';

export type EligibleSeriesResDtoOutputItemsItem = {
  id: string;
  title: string;
  /** @nullable */
  coverImage: string | null;
  /** Chỉ SERIALIZED / CANCELLING / COMPLETING mới lọt vào đây */
  status: EligibleSeriesResDtoOutputItemsItemStatus;
  /** @nullable */
   ...
   * @nullable
   */
  publicationType: EligibleSeriesResDtoOutputItemsItemPublicationType;
};
