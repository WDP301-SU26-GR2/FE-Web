...
export type SurveyControllerGetLatestVoteResultsPublicationType = typeof SurveyControllerGetLatestVoteResultsPublicationType[keyof typeof SurveyControllerGetLatestVoteResultsPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SurveyControllerGetLatestVoteResultsPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
