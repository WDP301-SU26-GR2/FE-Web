...
export type PublicRankingControllerGetLatestVoteResultsPublicationType = typeof PublicRankingControllerGetLatestVoteResultsPublicationType[keyof typeof PublicRankingControllerGetLatestVoteResultsPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicRankingControllerGetLatestVoteResultsPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
