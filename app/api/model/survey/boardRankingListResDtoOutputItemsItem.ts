 ...
 */
import type { BoardRankingListResDtoOutputItemsItemPublicationType } from './boardRankingListResDtoOutputItemsItemPublicationType';
import type { BoardRankingListResDtoOutputItemsItemRiskLevel } from './boardRankingListResDtoOutputItemsItemRiskLevel';

export type BoardRankingListResDtoOutputItemsItem = {
  seriesId: string;
  /** Reflected scoped survey period that produced this ranking row */
  surveyPeriodId: string;
  /**
   * Magazine scope; null only for legacy ranking rows
   * @nullable
   */
  magazine: string | null;
  /**
   * Publication type scope; null only for legacy ranking rows
   * @nullable
   */
  publicationType: BoardRankingListResDtoOutputItemsItemPublicationType;
  /**
   * Issue number of the source survey period
  ...
  riskLevel: BoardRankingListResDtoOutputItemsItemRiskLevel;
  isReliable: boolean;
  recordedAt: string;
};
