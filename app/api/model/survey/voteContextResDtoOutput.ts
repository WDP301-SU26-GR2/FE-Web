 ...
 */
import type { VoteContextResDtoOutputPeriod } from './voteContextResDtoOutputPeriod';
import type { VoteContextResDtoOutputSeriesItem } from './voteContextResDtoOutputSeriesItem';

export interface VoteContextResDtoOutput {
  /**
   * null = hiện không có kỳ bình chọn OPEN
   * @nullable
   */
  period: VoteContextResDtoOutputPeriod;
  series: VoteContextResDtoOutputSeriesItem[];
  /**
