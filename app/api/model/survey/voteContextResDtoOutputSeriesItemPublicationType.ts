 ...
 */
export type VoteContextResDtoOutputSeriesItemPublicationType = typeof VoteContextResDtoOutputSeriesItemPublicationType[keyof typeof VoteContextResDtoOutputSeriesItemPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const VoteContextResDtoOutputSeriesItemPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
