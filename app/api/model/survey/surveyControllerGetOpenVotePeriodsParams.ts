 ...
 */
import type { SurveyControllerGetOpenVotePeriodsPublicationType } from './surveyControllerGetOpenVotePeriodsPublicationType';

export type SurveyControllerGetOpenVotePeriodsParams = {
/**
 * Lọc theo tạp chí; bỏ trống = mọi tạp chí
 * @minLength 1
 */
magazine?: string;
/**
 * Lọc theo nhịp xuất bản (tab Tuần/Tháng); bỏ trống = mọi nhịp
 */
publicationType?: SurveyControllerGetOpenVotePeriodsPublicationType;
};
