...
export type VotingConfigBodyDtoAuthMode = typeof VotingConfigBodyDtoAuthMode[keyof typeof VotingConfigBodyDtoAuthMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const VotingConfigBodyDtoAuthMode = {
  OTP: 'OTP',
  CAPTCHA: 'CAPTCHA',
  HYBRID: 'HYBRID',
} as const;
