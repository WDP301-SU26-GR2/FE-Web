...
export type SurveyControllerGetEligibleSeriesPublicationType = typeof SurveyControllerGetEligibleSeriesPublicationType[keyof typeof SurveyControllerGetEligibleSeriesPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SurveyControllerGetEligibleSeriesPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
