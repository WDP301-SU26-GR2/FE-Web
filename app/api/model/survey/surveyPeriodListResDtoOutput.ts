 ...
 */
import type { SurveyPeriodListResDtoOutputItemsItem } from './surveyPeriodListResDtoOutputItemsItem';

export interface SurveyPeriodListResDtoOutput {
  items: SurveyPeriodListResDtoOutputItemsItem[];
  /**
   * @minimum 0
