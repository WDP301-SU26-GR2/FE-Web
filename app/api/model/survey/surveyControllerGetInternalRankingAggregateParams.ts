 ...
 */
import type { SurveyControllerGetInternalRankingAggregatePublicationType } from './surveyControllerGetInternalRankingAggregatePublicationType';
import type { SurveyControllerGetInternalRankingAggregateLevel } from './surveyControllerGetInternalRankingAggregateLevel';

export type SurveyControllerGetInternalRankingAggregateParams = {
/**
 * @minLength 1
 */
magazine: string;
 ...
 */
publicationType: SurveyControllerGetInternalRankingAggregatePublicationType;
/**
 * @minimum 1970
 * @maximum 9999
 */
year: number;
level: SurveyControllerGetInternalRankingAggregateLevel;
/**
 * @minimum 1
 * @maximum 12
 */
