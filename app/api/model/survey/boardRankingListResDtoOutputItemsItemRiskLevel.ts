 ...
 */
export type BoardRankingListResDtoOutputItemsItemRiskLevel = typeof BoardRankingListResDtoOutputItemsItemRiskLevel[keyof typeof BoardRankingListResDtoOutputItemsItemRiskLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const BoardRankingListResDtoOutputItemsItemRiskLevel = {
  NONE: 'NONE',
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  SEVERE: 'SEVERE',
