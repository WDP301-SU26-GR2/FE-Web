 ...
 */
export type OpenVotePeriodsResDtoOutputItemsItemPublicationType = typeof OpenVotePeriodsResDtoOutputItemsItemPublicationType[keyof typeof OpenVotePeriodsResDtoOutputItemsItemPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const OpenVotePeriodsResDtoOutputItemsItemPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
