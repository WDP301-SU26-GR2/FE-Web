 ...
 */
import type { VotePeriodsResDtoOutputItemsItem } from './votePeriodsResDtoOutputItemsItem';

export interface VotePeriodsResDtoOutput {
  items: VotePeriodsResDtoOutputItemsItem[];
}
