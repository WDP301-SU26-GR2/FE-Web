 ...
 */
import type { LatestVoteResultsResDtoOutputPeriod } from './latestVoteResultsResDtoOutputPeriod';
import type { LatestVoteResultsResDtoOutputResultsItem } from './latestVoteResultsResDtoOutputResultsItem';

export interface LatestVoteResultsResDtoOutput {
  /**
   * null = chưa có kỳ nào REFLECTED
   * @nullable
   */
  period: LatestVoteResultsResDtoOutputPeriod;
  results: LatestVoteResultsResDtoOutputResultsItem[];
}
