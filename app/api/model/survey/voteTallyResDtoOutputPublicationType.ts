 ...
 */
export type VoteTallyResDtoOutputPublicationType = typeof VoteTallyResDtoOutputPublicationType[keyof typeof VoteTallyResDtoOutputPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const VoteTallyResDtoOutputPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
