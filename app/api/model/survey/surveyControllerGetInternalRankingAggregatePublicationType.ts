...
export type SurveyControllerGetInternalRankingAggregatePublicationType = typeof SurveyControllerGetInternalRankingAggregatePublicationType[keyof typeof SurveyControllerGetInternalRankingAggregatePublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SurveyControllerGetInternalRankingAggregatePublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
