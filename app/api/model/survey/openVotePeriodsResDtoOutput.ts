 ...
 */
import type { OpenVotePeriodsResDtoOutputItemsItem } from './openVotePeriodsResDtoOutputItemsItem';

export interface OpenVotePeriodsResDtoOutput {
  items: OpenVotePeriodsResDtoOutputItemsItem[];
}
