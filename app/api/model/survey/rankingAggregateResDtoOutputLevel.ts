...
export type RankingAggregateResDtoOutputLevel = typeof RankingAggregateResDtoOutputLevel[keyof typeof RankingAggregateResDtoOutputLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RankingAggregateResDtoOutputLevel = {
  MONTH: 'MONTH',
  YEAR: 'YEAR',
} as const;
