 ...
 */
export type RankingAggregateResDtoOutputPublicationType = typeof RankingAggregateResDtoOutputPublicationType[keyof typeof RankingAggregateResDtoOutputPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RankingAggregateResDtoOutputPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
