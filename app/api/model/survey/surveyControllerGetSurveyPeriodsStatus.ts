...
export type SurveyControllerGetSurveyPeriodsStatus = typeof SurveyControllerGetSurveyPeriodsStatus[keyof typeof SurveyControllerGetSurveyPeriodsStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SurveyControllerGetSurveyPeriodsStatus = {
  DRAFT: 'DRAFT',
  OPEN: 'OPEN',
  CLOSED: 'CLOSED',
  REFLECTED: 'REFLECTED',
