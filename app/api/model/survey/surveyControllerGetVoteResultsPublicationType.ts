...
export type SurveyControllerGetVoteResultsPublicationType = typeof SurveyControllerGetVoteResultsPublicationType[keyof typeof SurveyControllerGetVoteResultsPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SurveyControllerGetVoteResultsPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
