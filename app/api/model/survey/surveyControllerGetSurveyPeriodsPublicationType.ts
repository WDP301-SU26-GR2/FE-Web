...
export type SurveyControllerGetSurveyPeriodsPublicationType = typeof SurveyControllerGetSurveyPeriodsPublicationType[keyof typeof SurveyControllerGetSurveyPeriodsPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SurveyControllerGetSurveyPeriodsPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
