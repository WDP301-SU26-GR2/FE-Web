 ...
 */
export type CreateSurveyPeriodBodyDtoPublicationType = typeof CreateSurveyPeriodBodyDtoPublicationType[keyof typeof CreateSurveyPeriodBodyDtoPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateSurveyPeriodBodyDtoPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
