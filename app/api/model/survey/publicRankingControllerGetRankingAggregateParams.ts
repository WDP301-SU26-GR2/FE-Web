 ...
 */
import type { PublicRankingControllerGetRankingAggregatePublicationType } from './publicRankingControllerGetRankingAggregatePublicationType';
import type { PublicRankingControllerGetRankingAggregateLevel } from './publicRankingControllerGetRankingAggregateLevel';

export type PublicRankingControllerGetRankingAggregateParams = {
/**
 * @minLength 1
 */
magazine: string;
 ...
 */
publicationType: PublicRankingControllerGetRankingAggregatePublicationType;
/**
 * @minimum 1970
 * @maximum 9999
 */
year: number;
level: PublicRankingControllerGetRankingAggregateLevel;
/**
 * @minimum 1
 * @maximum 12
 */
