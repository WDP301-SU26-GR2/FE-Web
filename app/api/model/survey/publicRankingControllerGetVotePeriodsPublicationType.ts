...
export type PublicRankingControllerGetVotePeriodsPublicationType = typeof PublicRankingControllerGetVotePeriodsPublicationType[keyof typeof PublicRankingControllerGetVotePeriodsPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicRankingControllerGetVotePeriodsPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
