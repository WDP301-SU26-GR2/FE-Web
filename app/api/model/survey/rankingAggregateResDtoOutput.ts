 ...
 */
import type { RankingAggregateResDtoOutputPublicationType } from './rankingAggregateResDtoOutputPublicationType';
import type { RankingAggregateResDtoOutputLevel } from './rankingAggregateResDtoOutputLevel';
import type { RankingAggregateResDtoOutputItemsItem } from './rankingAggregateResDtoOutputItemsItem';

export interface RankingAggregateResDtoOutput {
  magazine: string;
  /** Publication cadence: WEEKLY, MONTHLY, IRREGULAR. Values: WEEKLY, MONTHLY, IRREGULAR */
  publicationType: RankingAggregateResDtoOutputPublicationType;
  level: RankingAggregateResDtoOutputLevel;
  /**
  ...
  items: RankingAggregateResDtoOutputItemsItem[];
}
