 ...
 */
import type { EligibleSeriesResDtoOutputItemsItem } from './eligibleSeriesResDtoOutputItemsItem';

export interface EligibleSeriesResDtoOutput {
  items: EligibleSeriesResDtoOutputItemsItem[];
  /**
   * @minimum 0
