 ...
 */
export type CreateSurveyPeriodBodyDtoStatus = typeof CreateSurveyPeriodBodyDtoStatus[keyof typeof CreateSurveyPeriodBodyDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateSurveyPeriodBodyDtoStatus = {
  DRAFT: 'DRAFT',
  OPEN: 'OPEN',
  CLOSED: 'CLOSED',
  REFLECTED: 'REFLECTED',
