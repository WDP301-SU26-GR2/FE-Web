 ...
 */
import type { CreateSurveyPeriodBodyDtoPublicationType } from './createSurveyPeriodBodyDtoPublicationType';
import type { CreateSurveyPeriodBodyDtoStatus } from './createSurveyPeriodBodyDtoStatus';

export interface CreateSurveyPeriodBodyDto {
  /**
   * @minimum 0
  ...
  publicationType: CreateSurveyPeriodBodyDtoPublicationType;
  /** @minItems 1 */
  ...
  status?: CreateSurveyPeriodBodyDtoStatus;
}
