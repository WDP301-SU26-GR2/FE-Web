 ...
 */
import type { VoteResultsResDtoOutputResultsItem } from './voteResultsResDtoOutputResultsItem';

export interface VoteResultsResDtoOutput {
  ...
  results: VoteResultsResDtoOutputResultsItem[];
}
