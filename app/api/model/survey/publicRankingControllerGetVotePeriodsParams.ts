 ...
 */
import type { PublicRankingControllerGetVotePeriodsPublicationType } from './publicRankingControllerGetVotePeriodsPublicationType';

export type PublicRankingControllerGetVotePeriodsParams = {
/**
 * @minLength 1
 */
magazine: string;
 ...
 */
publicationType: PublicRankingControllerGetVotePeriodsPublicationType;
/**
 * @minimum 1
 * @maximum 24
 */
