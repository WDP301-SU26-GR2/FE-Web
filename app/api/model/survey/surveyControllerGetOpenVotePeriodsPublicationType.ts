...
export type SurveyControllerGetOpenVotePeriodsPublicationType = typeof SurveyControllerGetOpenVotePeriodsPublicationType[keyof typeof SurveyControllerGetOpenVotePeriodsPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SurveyControllerGetOpenVotePeriodsPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
