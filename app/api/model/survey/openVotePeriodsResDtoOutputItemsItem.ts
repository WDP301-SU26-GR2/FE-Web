 ...
 */
import type { OpenVotePeriodsResDtoOutputItemsItemPublicationType } from './openVotePeriodsResDtoOutputItemsItemPublicationType';

export type OpenVotePeriodsResDtoOutputItemsItem = {
  /** Dùng làm periodId cho /vote/context, /vote/live, POST /vote */
  id: string;
  magazine: string;
  /** Publication cadence: WEEKLY, MONTHLY, IRREGULAR. Values: WEEKLY, MONTHLY, IRREGULAR */
  publicationType: OpenVotePeriodsResDtoOutputItemsItemPublicationType;
  /**
  ...
  /**
   * ISO 8601 UTC — null = chưa ấn định ngày đóng
   * @nullable
   */
  endDate: string | null;
};
