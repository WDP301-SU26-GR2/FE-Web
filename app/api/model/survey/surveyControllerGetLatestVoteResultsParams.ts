 ...
 */
import type { SurveyControllerGetLatestVoteResultsPublicationType } from './surveyControllerGetLatestVoteResultsPublicationType';

export type SurveyControllerGetLatestVoteResultsParams = {
/**
 * Publication cadence: WEEKLY, MONTHLY, IRREGULAR. Values: WEEKLY, MONTHLY, IRREGULAR
 */
publicationType?: SurveyControllerGetLatestVoteResultsPublicationType;
};
