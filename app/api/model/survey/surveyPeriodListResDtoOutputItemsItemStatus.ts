 ...
 */
export type SurveyPeriodListResDtoOutputItemsItemStatus = typeof SurveyPeriodListResDtoOutputItemsItemStatus[keyof typeof SurveyPeriodListResDtoOutputItemsItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SurveyPeriodListResDtoOutputItemsItemStatus = {
  DRAFT: 'DRAFT',
  OPEN: 'OPEN',
  CLOSED: 'CLOSED',
  REFLECTED: 'REFLECTED',
