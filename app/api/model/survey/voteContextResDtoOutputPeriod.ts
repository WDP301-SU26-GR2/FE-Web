 ...
 */
import type { VoteContextResDtoOutputPeriodPublicationType } from './voteContextResDtoOutputPeriodPublicationType';

/**
 * null = hiện không có kỳ bình chọn OPEN
 * @nullable
 */
export type VoteContextResDtoOutputPeriod = {
  id: string;
  magazine?: string;
  /** Publication cadence: WEEKLY, MONTHLY, IRREGULAR. Values: WEEKLY, MONTHLY, IRREGULAR */
  publicationType?: VoteContextResDtoOutputPeriodPublicationType;
  /**
