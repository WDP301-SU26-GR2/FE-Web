 ...
 */
export type RankingRecordListResDtoOutputItemsItemRiskLevel = typeof RankingRecordListResDtoOutputItemsItemRiskLevel[keyof typeof RankingRecordListResDtoOutputItemsItemRiskLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RankingRecordListResDtoOutputItemsItemRiskLevel = {
  NONE: 'NONE',
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  SEVERE: 'SEVERE',
