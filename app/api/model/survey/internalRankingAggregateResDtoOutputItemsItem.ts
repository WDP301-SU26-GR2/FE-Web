 ...
 */
import type { InternalRankingAggregateResDtoOutputItemsItemRiskLevel } from './internalRankingAggregateResDtoOutputItemsItemRiskLevel';

export type InternalRankingAggregateResDtoOutputItemsItem = {
  /**
   * @minimum 0
  ...
  riskLevel: InternalRankingAggregateResDtoOutputItemsItemRiskLevel;
  isReliable: boolean;
};
