 ...
 */
export type InternalRankingAggregateResDtoOutputPublicationType = typeof InternalRankingAggregateResDtoOutputPublicationType[keyof typeof InternalRankingAggregateResDtoOutputPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const InternalRankingAggregateResDtoOutputPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
