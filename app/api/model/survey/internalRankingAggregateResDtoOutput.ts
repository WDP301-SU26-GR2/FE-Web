 ...
 */
import type { InternalRankingAggregateResDtoOutputPublicationType } from './internalRankingAggregateResDtoOutputPublicationType';
import type { InternalRankingAggregateResDtoOutputLevel } from './internalRankingAggregateResDtoOutputLevel';
import type { InternalRankingAggregateResDtoOutputItemsItem } from './internalRankingAggregateResDtoOutputItemsItem';

export interface InternalRankingAggregateResDtoOutput {
  magazine: string;
  /** Publication cadence: WEEKLY, MONTHLY, IRREGULAR. Values: WEEKLY, MONTHLY, IRREGULAR */
  publicationType: InternalRankingAggregateResDtoOutputPublicationType;
  level: InternalRankingAggregateResDtoOutputLevel;
  /**
  ...
  items: InternalRankingAggregateResDtoOutputItemsItem[];
}
