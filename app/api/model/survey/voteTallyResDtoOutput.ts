 ...
 */
import type { VoteTallyResDtoOutputPublicationType } from './voteTallyResDtoOutputPublicationType';
import type { VoteTallyResDtoOutputTallyItem } from './voteTallyResDtoOutputTallyItem';

export interface VoteTallyResDtoOutput {
  periodId: string;
  magazine: string;
  /** Publication cadence: WEEKLY, MONTHLY, IRREGULAR. Values: WEEKLY, MONTHLY, IRREGULAR */
  publicationType: VoteTallyResDtoOutputPublicationType;
  /**
  ...
  tally: VoteTallyResDtoOutputTallyItem[];
  /**
   * Valid ballot count; it can differ from sum(tally[].count)
   * @minimum 0
   * @maximum 9007199254740991
   */
  totalVotes: number;
