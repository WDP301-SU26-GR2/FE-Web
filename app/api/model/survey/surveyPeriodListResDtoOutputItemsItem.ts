 ...
 */
import type { SurveyPeriodListResDtoOutputItemsItemPublicationType } from './surveyPeriodListResDtoOutputItemsItemPublicationType';
import type { SurveyPeriodListResDtoOutputItemsItemStatus } from './surveyPeriodListResDtoOutputItemsItemStatus';

export type SurveyPeriodListResDtoOutputItemsItem = {
  id: string;
  /** @nullable */
   ...
   * @nullable
   */
  publicationType: SurveyPeriodListResDtoOutputItemsItemPublicationType;
  ...
  status: SurveyPeriodListResDtoOutputItemsItemStatus;
};
