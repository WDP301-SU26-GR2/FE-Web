 ...
 */
export type InternalRankingAggregateResDtoOutputItemsItemRiskLevel = typeof InternalRankingAggregateResDtoOutputItemsItemRiskLevel[keyof typeof InternalRankingAggregateResDtoOutputItemsItemRiskLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const InternalRankingAggregateResDtoOutputItemsItemRiskLevel = {
  NONE: 'NONE',
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  SEVERE: 'SEVERE',
