 ...
 */
import type { LatestVoteResultsResDtoOutputResultsItemPublicationType } from './latestVoteResultsResDtoOutputResultsItemPublicationType';

export type LatestVoteResultsResDtoOutputResultsItem = {
  /**
   ...
   * @nullable
   */
  publicationType: LatestVoteResultsResDtoOutputResultsItemPublicationType;
  voteCount: number;
  /**
   * @minimum -9007199254740991
   * @maximum 9007199254740991
