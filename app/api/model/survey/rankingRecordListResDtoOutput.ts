 ...
 */
import type { RankingRecordListResDtoOutputItemsItem } from './rankingRecordListResDtoOutputItemsItem';

export interface RankingRecordListResDtoOutput {
  items: RankingRecordListResDtoOutputItemsItem[];
}
