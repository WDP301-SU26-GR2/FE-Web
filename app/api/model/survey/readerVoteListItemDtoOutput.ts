 ...
 */
import type { ReaderVoteListItemDtoOutputPublicationType } from './readerVoteListItemDtoOutputPublicationType';
import type { ReaderVoteListItemDtoOutputAuthMethod } from './readerVoteListItemDtoOutputAuthMethod';

export interface ReaderVoteListItemDtoOutput {
  id: string;
   ...
   * @nullable
   */
  publicationType: ReaderVoteListItemDtoOutputPublicationType;
  /** @nullable */
  authMethod: ReaderVoteListItemDtoOutputAuthMethod;
  voteWeight: number;
  isFlagged: boolean;
  /**
