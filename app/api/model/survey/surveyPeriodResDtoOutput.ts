 ...
 */
import type { SurveyPeriodResDtoOutputPublicationType } from './surveyPeriodResDtoOutputPublicationType';
import type { SurveyPeriodResDtoOutputStatus } from './surveyPeriodResDtoOutputStatus';

export interface SurveyPeriodResDtoOutput {
  id: string;
  /** @nullable */
   ...
   * @nullable
   */
  publicationType: SurveyPeriodResDtoOutputPublicationType;
  ...
  status: SurveyPeriodResDtoOutputStatus;
}
