...
export type PublicRankingControllerGetRankingAggregateLevel = typeof PublicRankingControllerGetRankingAggregateLevel[keyof typeof PublicRankingControllerGetRankingAggregateLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicRankingControllerGetRankingAggregateLevel = {
  MONTH: 'MONTH',
  YEAR: 'YEAR',
} as const;
