...
export type VotingConfigResDtoOutputAuthMode = typeof VotingConfigResDtoOutputAuthMode[keyof typeof VotingConfigResDtoOutputAuthMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const VotingConfigResDtoOutputAuthMode = {
  OTP: 'OTP',
  CAPTCHA: 'CAPTCHA',
  HYBRID: 'HYBRID',
} as const;
