 ...
 */
export type VoteContextResDtoOutputPeriodPublicationType = typeof VoteContextResDtoOutputPeriodPublicationType[keyof typeof VoteContextResDtoOutputPeriodPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const VoteContextResDtoOutputPeriodPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
