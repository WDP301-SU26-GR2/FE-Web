 ...
 */
import type { PublicRankingControllerGetLatestVoteResultsPublicationType } from './publicRankingControllerGetLatestVoteResultsPublicationType';

export type PublicRankingControllerGetLatestVoteResultsParams = {
/**
 * @minLength 1
 */
magazine: string;
 ...
 */
publicationType: PublicRankingControllerGetLatestVoteResultsPublicationType;
};
