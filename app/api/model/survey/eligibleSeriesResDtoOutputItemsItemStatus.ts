 ...
 */
export type EligibleSeriesResDtoOutputItemsItemStatus = typeof EligibleSeriesResDtoOutputItemsItemStatus[keyof typeof EligibleSeriesResDtoOutputItemsItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EligibleSeriesResDtoOutputItemsItemStatus = {
  DRAFT: 'DRAFT',
  IN_REVIEW: 'IN_REVIEW',
  READY_TO_PITCH: 'READY_TO_PITCH',
  PITCHED: 'PITCHED',
