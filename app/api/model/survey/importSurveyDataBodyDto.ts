 ...
 */
import type { ImportSurveyDataBodyDtoEntriesItem } from './importSurveyDataBodyDtoEntriesItem';

export interface ImportSurveyDataBodyDto {
  /** @minLength 1 */
  ...
  surveyDate?: string;
  /** @minItems 1 */
  entries: ImportSurveyDataBodyDtoEntriesItem[];
}
