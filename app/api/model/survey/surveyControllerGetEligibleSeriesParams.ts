 ...
 */
import type { SurveyControllerGetEligibleSeriesPublicationType } from './surveyControllerGetEligibleSeriesPublicationType';

export type SurveyControllerGetEligibleSeriesParams = {
/**
 * @minLength 1
 */
magazine: string;
 ...
 */
publicationType: SurveyControllerGetEligibleSeriesPublicationType;
};
