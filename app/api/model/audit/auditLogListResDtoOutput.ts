 ...
 */
import type { AuditLogListResDtoOutputItemsItem } from './auditLogListResDtoOutputItemsItem';

export interface AuditLogListResDtoOutput {
  items: AuditLogListResDtoOutputItemsItem[];
  total: number;
  limit: number;
  offset: number;
}
