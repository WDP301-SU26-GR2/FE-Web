...
export type AuditLogListResDtoOutputItemsItem = {
   ...
   */
  actorId: string | null;
  /** Audited entity type: SERIES, MANUSCRIPT, PAGE, CHAPTER, TASK, DEADLINE_REQUEST, USER, REGION, APP_CONFIG, CONTRACT, BOARD_DECISION, REPRINT_REQUEST, TRANSFER_REQUEST. Values: SERIES, MANUSCRIPT, PAGE, CHAPTER, TASK, DEADLINE_REQUEST, USER, REGION, APP_CONFIG, CONTRACT, BOARD_DECISION, REPRINT_REQUEST, TRANSFER_REQUEST, PAYMENT_RECORD, SURVEY_PERIOD, PUBLICATION_VERSION, BOARD_SESSION */
