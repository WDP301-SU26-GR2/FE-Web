 ...
 */
import type { CreateProposalResDtoOutputSeriesMangaka } from './createProposalResDtoOutputSeriesMangaka';
import type { CreateProposalResDtoOutputSeriesEditor } from './createProposalResDtoOutputSeriesEditor';
...
export type CreateProposalResDtoOutputSeries = {
  ...
  mangaka?: CreateProposalResDtoOutputSeriesMangaka;
  /**
   * Thông tin hiển thị editor; null = hàng đợi — CÓ ở GET /series + GET /series/:id
   * @nullable
   */
  editor?: CreateProposalResDtoOutputSeriesEditor;
  /**
