 ...
 */
import type { SeriesListResDtoOutputItemsItemProposalStatus } from './seriesListResDtoOutputItemsItemProposalStatus';

/**
 * Hồ sơ proposal (nhúng trong Series); null nếu chưa có
 * @nullable
 */
export type SeriesListResDtoOutputItemsItemProposal = {
  /**
  ...
  status: SeriesListResDtoOutputItemsItemProposalStatus;
  /** ISO 8601 */
  createdAt: string;
} | null;
