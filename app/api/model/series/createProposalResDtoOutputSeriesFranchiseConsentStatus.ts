 ...
 * @nullable
 */
export type CreateProposalResDtoOutputSeriesFranchiseConsentStatus = typeof CreateProposalResDtoOutputSeriesFranchiseConsentStatus[keyof typeof CreateProposalResDtoOutputSeriesFranchiseConsentStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateProposalResDtoOutputSeriesFranchiseConsentStatus = {
  PENDING: 'PENDING',
  APPROVED: 'APPROVED',
  REJECTED: 'REJECTED',
} as const;
