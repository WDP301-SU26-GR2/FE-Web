...
/**
 * Series proposal review status. Values: DRAFT, PROPOSAL_REVIEW, PROPOSAL_REVISION, PROPOSAL_APPROVED, PITCHED, APPROVED, REJECTED, WITHDRAWN
 */
export type CreateProposalResDtoOutputSeriesProposalStatus = typeof CreateProposalResDtoOutputSeriesProposalStatus[keyof typeof CreateProposalResDtoOutputSeriesProposalStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateProposalResDtoOutputSeriesProposalStatus = {
  DRAFT: 'DRAFT',
