 ...
 */
export type CreateProposalResDtoOutputNameKind = typeof CreateProposalResDtoOutputNameKind[keyof typeof CreateProposalResDtoOutputNameKind];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateProposalResDtoOutputNameKind = {
  PROPOSAL: 'PROPOSAL',
  CHAPTER: 'CHAPTER',
} as const;
