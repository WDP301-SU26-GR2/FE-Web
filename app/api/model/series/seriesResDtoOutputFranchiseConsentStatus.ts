 ...
 * @nullable
 */
export type SeriesResDtoOutputFranchiseConsentStatus = typeof SeriesResDtoOutputFranchiseConsentStatus[keyof typeof SeriesResDtoOutputFranchiseConsentStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesResDtoOutputFranchiseConsentStatus = {
  PENDING: 'PENDING',
  APPROVED: 'APPROVED',
  REJECTED: 'REJECTED',
} as const;
