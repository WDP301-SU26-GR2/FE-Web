...
export type SeriesControllerListSeriesPublicationType = typeof SeriesControllerListSeriesPublicationType[keyof typeof SeriesControllerListSeriesPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesControllerListSeriesPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
