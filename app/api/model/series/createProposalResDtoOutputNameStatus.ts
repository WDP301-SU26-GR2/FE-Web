 ...
 */
export type CreateProposalResDtoOutputNameStatus = typeof CreateProposalResDtoOutputNameStatus[keyof typeof CreateProposalResDtoOutputNameStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateProposalResDtoOutputNameStatus = {
  DRAFT: 'DRAFT',
  SUBMITTED: 'SUBMITTED',
  IN_REVIEW: 'IN_REVIEW',
  REVISION: 'REVISION',
