 ...
 */
import type { CreateProposalResDtoOutputSeriesProposalStatus } from './createProposalResDtoOutputSeriesProposalStatus';

/**
 * Hồ sơ proposal (nhúng trong Series); null nếu chưa có
 * @nullable
 */
export type CreateProposalResDtoOutputSeriesProposal = {
  /**
  ...
  status: CreateProposalResDtoOutputSeriesProposalStatus;
  /** ISO 8601 */
  createdAt: string;
} | null;
