 ...
 */
export type CreateProposalBodyDtoDemographic = typeof CreateProposalBodyDtoDemographic[keyof typeof CreateProposalBodyDtoDemographic];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateProposalBodyDtoDemographic = {
  SHONEN: 'SHONEN',
  SEINEN: 'SEINEN',
  SHOJO: 'SHOJO',
  JOSEI: 'JOSEI',
