 ...
 * @nullable
 */
export type SeriesListResDtoOutputItemsItemFranchiseConsentStatus = typeof SeriesListResDtoOutputItemsItemFranchiseConsentStatus[keyof typeof SeriesListResDtoOutputItemsItemFranchiseConsentStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesListResDtoOutputItemsItemFranchiseConsentStatus = {
  PENDING: 'PENDING',
  APPROVED: 'APPROVED',
  REJECTED: 'REJECTED',
} as const;
