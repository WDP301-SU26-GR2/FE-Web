...
export type BoardControllerGetSessionsStatus = typeof BoardControllerGetSessionsStatus[keyof typeof BoardControllerGetSessionsStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const BoardControllerGetSessionsStatus = {
  UPCOMING: 'UPCOMING',
  ACTIVE: 'ACTIVE',
  CONCLUDED: 'CONCLUDED',
} as const;
