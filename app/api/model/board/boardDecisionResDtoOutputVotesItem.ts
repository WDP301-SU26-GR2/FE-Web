 ...
 */
import type { BoardDecisionResDtoOutputVotesItemVoteValue } from './boardDecisionResDtoOutputVotesItemVoteValue';

export type BoardDecisionResDtoOutputVotesItem = {
  /** @nullable */
  voterId?: string | null;
  /**
   ...
   * @nullable
   */
  voteValue?: BoardDecisionResDtoOutputVotesItemVoteValue;
  /** @nullable */
  note?: string | null;
  /**
