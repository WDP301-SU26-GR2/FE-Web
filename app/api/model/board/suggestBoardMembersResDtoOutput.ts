 ...
 */
import type { SuggestBoardMembersResDtoOutputItemsItem } from './suggestBoardMembersResDtoOutputItemsItem';

export interface SuggestBoardMembersResDtoOutput {
  items: SuggestBoardMembersResDtoOutputItemsItem[];
  /** Sĩ số roster đề xuất — LUÔN lẻ và >= 3 */
  size: number;
}
