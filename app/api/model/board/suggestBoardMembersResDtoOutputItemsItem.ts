 ...
 */
import type { SuggestBoardMembersResDtoOutputItemsItemSpecialtyGenresItem } from './suggestBoardMembersResDtoOutputItemsItemSpecialtyGenresItem';
import type { SuggestBoardMembersResDtoOutputItemsItemMatchedGenresItem } from './suggestBoardMembersResDtoOutputItemsItemMatchedGenresItem';

export type SuggestBoardMembersResDtoOutputItemsItem = {
  userId: string;
  /** @nullable */
  displayName: string | null;
  /** @nullable */
  avatar: string | null;
  specialtyGenres: SuggestBoardMembersResDtoOutputItemsItemSpecialtyGenresItem[];
  /** Giao giữa sở trường và thể loại của series */
  matchedGenres: SuggestBoardMembersResDtoOutputItemsItemMatchedGenresItem[];
  /** Số thể loại khớp */
  score: number;
  hasProfile: boolean;
};
