 ...
 */
import type { BoardControllerGetSessionsMine } from './boardControllerGetSessionsMine';
import type { BoardControllerGetSessionsStatus } from './boardControllerGetSessionsStatus';

export type BoardControllerGetSessionsParams = {
/**
 * 'true' = chỉ phiên caller là creator hoặc trong roster
 */
mine?: BoardControllerGetSessionsMine;
/**
 * Board session status: UPCOMING (chờ tới giờ), ACTIVE (đang họp/vote), CONCLUDED (đã bế mạc). Values: UPCOMING, ACTIVE, CONCLUDED
 */
status?: BoardControllerGetSessionsStatus;
};
