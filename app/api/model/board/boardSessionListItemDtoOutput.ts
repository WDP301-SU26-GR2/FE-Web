 ...
 */
import type { BoardSessionListItemDtoOutputStatus } from './boardSessionListItemDtoOutputStatus';
import type { BoardSessionListItemDtoOutputPhase } from './boardSessionListItemDtoOutputPhase';
import type { BoardSessionListItemDtoOutputCreator } from './boardSessionListItemDtoOutputCreator';

export interface BoardSessionListItemDtoOutput {
  id: string;
  title: string;
  creatorId: string;
  /** Board session status: UPCOMING (chờ tới giờ), ACTIVE (đang họp/vote), CONCLUDED (đã bế mạc). Values: UPCOMING, ACTIVE, CONCLUDED */
  status: BoardSessionListItemDtoOutputStatus;
  ...
  phase: BoardSessionListItemDtoOutputPhase;
  /** CÓ ở GET /board/sessions + GET /board/sessions/:id (enrich) */
  creator?: BoardSessionListItemDtoOutputCreator;
  /**
