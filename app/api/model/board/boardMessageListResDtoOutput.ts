 ...
 */
import type { BoardMessageListResDtoOutputItemsItem } from './boardMessageListResDtoOutputItemsItem';

export interface BoardMessageListResDtoOutput {
  items: BoardMessageListResDtoOutputItemsItem[];
  /**
