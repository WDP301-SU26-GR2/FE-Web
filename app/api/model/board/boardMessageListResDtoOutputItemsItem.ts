 ...
 */
import type { BoardMessageListResDtoOutputItemsItemSender } from './boardMessageListResDtoOutputItemsItemSender';
import type { BoardMessageListResDtoOutputItemsItemPhase } from './boardMessageListResDtoOutputItemsItemPhase';

export type BoardMessageListResDtoOutputItemsItem = {
  id: string;
  sessionId: string;
  sender: BoardMessageListResDtoOutputItemsItemSender;
  content: string;
  /** Phase lúc tin nhắn được gửi */
  phase: BoardMessageListResDtoOutputItemsItemPhase;
  /**
