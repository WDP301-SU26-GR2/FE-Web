 ...
 */
export type BoardSessionListItemDtoOutputStatus = typeof BoardSessionListItemDtoOutputStatus[keyof typeof BoardSessionListItemDtoOutputStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const BoardSessionListItemDtoOutputStatus = {
  UPCOMING: 'UPCOMING',
  ACTIVE: 'ACTIVE',
  CONCLUDED: 'CONCLUDED',
} as const;
