 ...
 */
import type { ReprintChapterResDtoOutputStatus } from './reprintChapterResDtoOutputStatus';

export interface ReprintChapterResDtoOutput {
  /** @nullable */
  originalChapterId: string | null;
  /** @nullable */
  manuscriptFile: string | null;
  status: ReprintChapterResDtoOutputStatus;
}
