 ...
 */
import type { AssignReviserBodyDtoReviserType } from './assignReviserBodyDtoReviserType';

export interface AssignReviserBodyDto {
  /** @minLength 1 */
  reviserId: string;
  reviserType: AssignReviserBodyDtoReviserType;
}
