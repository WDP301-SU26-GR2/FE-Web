 ...
 */
import type { ReprintRequestResDtoOutputChaptersItemStatus } from './reprintRequestResDtoOutputChaptersItemStatus';

export type ReprintRequestResDtoOutputChaptersItem = {
  /** @nullable */
  originalChapterId: string | null;
  /** @nullable */
  manuscriptFile: string | null;
  status: ReprintRequestResDtoOutputChaptersItemStatus;
};
