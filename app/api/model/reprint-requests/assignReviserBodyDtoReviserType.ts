...
export type AssignReviserBodyDtoReviserType = typeof AssignReviserBodyDtoReviserType[keyof typeof AssignReviserBodyDtoReviserType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AssignReviserBodyDtoReviserType = {
  INTERNAL_TEAM: 'INTERNAL_TEAM',
  OTHER_MANGAKA: 'OTHER_MANGAKA',
} as const;
