 ...
 */
import type { BatchCreateTaskBodyDtoItemsItem } from './batchCreateTaskBodyDtoItemsItem';

export interface BatchCreateTaskBodyDto {
  /**
   * @minItems 1
   * @maxItems 50
   */
  items: BatchCreateTaskBodyDtoItemsItem[];
}
