 ...
 */
import type { TaskGroupResDtoOutputItemsItemVersionsItemReviewStatus } from './taskGroupResDtoOutputItemsItemVersionsItemReviewStatus';
import type { TaskGroupResDtoOutputItemsItemVersionsItemSubmitter } from './taskGroupResDtoOutputItemsItemVersionsItemSubmitter';

export type TaskGroupResDtoOutputItemsItemVersionsItem = {
  /** @nullable */
  ...
  reviewStatus: TaskGroupResDtoOutputItemsItemVersionsItemReviewStatus;
  /** @nullable */
   ...
   * @nullable
   */
  submitter?: TaskGroupResDtoOutputItemsItemVersionsItemSubmitter;
};
