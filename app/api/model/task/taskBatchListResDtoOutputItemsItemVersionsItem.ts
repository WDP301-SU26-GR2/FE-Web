 ...
 */
import type { TaskBatchListResDtoOutputItemsItemVersionsItemReviewStatus } from './taskBatchListResDtoOutputItemsItemVersionsItemReviewStatus';
import type { TaskBatchListResDtoOutputItemsItemVersionsItemSubmitter } from './taskBatchListResDtoOutputItemsItemVersionsItemSubmitter';

export type TaskBatchListResDtoOutputItemsItemVersionsItem = {
  /** @nullable */
  submittedBy: string | null;
  versionNumber: number;
  /** @nullable */
  file: string | null;
  /** Trạng thái review của 1 bản nộp task: PENDING, APPROVED, REVISION_REQUESTED. Values: PENDING, APPROVED, REVISION_REQUESTED */
  reviewStatus: TaskBatchListResDtoOutputItemsItemVersionsItemReviewStatus;
  /** @nullable */
  reviewerNote: string | null;
  submittedAt: string;
  /**
   * Người nộp phiên bản — có ở GET list/detail
   * @nullable
   */
  submitter?: TaskBatchListResDtoOutputItemsItemVersionsItemSubmitter;
};
