 ...
 */
import type { RegionListResDtoOutputItemsItem } from './regionListResDtoOutputItemsItem';

export interface RegionListResDtoOutput {
  items: RegionListResDtoOutputItemsItem[];
}
