 ...
 */
import type { TaskListResDtoOutputItemsItemVersionsItemReviewStatus } from './taskListResDtoOutputItemsItemVersionsItemReviewStatus';
import type { TaskListResDtoOutputItemsItemVersionsItemSubmitter } from './taskListResDtoOutputItemsItemVersionsItemSubmitter';

export type TaskListResDtoOutputItemsItemVersionsItem = {
  /** @nullable */
  ...
  reviewStatus: TaskListResDtoOutputItemsItemVersionsItemReviewStatus;
  /** @nullable */
   ...
   * @nullable
   */
  submitter?: TaskListResDtoOutputItemsItemVersionsItemSubmitter;
};
