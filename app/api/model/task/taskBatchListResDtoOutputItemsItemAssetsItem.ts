 ...
 */
import type { TaskBatchListResDtoOutputItemsItemAssetsItemAssetType } from './taskBatchListResDtoOutputItemsItemAssetsItemAssetType';

export type TaskBatchListResDtoOutputItemsItemAssetsItem = {
  /** ObjectId Asset (= một phần tử của assetIds) */
  id: string;
  /** Object key R2 — truyền vào POST /tasks/:id/download-url để tải reference */
  filePath: string;
  name: string;
  /**
   ...
   * @nullable
   */
  assetType: TaskBatchListResDtoOutputItemsItemAssetsItemAssetType;
};
