 ...
 */
import type { CreateRegionBodyDtoCoordinates } from './createRegionBodyDtoCoordinates';
import type { CreateRegionBodyDtoRegionType } from './createRegionBodyDtoRegionType';

export interface CreateRegionBodyDto {
  /** Toạ độ vùng trên trang (pixel, top-left origin; x,y ≥ 0; width,height > 0) */
  coordinates: CreateRegionBodyDtoCoordinates;
  /** Loại vùng trên trang: PANEL, BACKGROUND, SPEECH_BUBBLE, SFX, CHARACTER. Values: PANEL, BACKGROUND, SPEECH_BUBBLE, SFX, CHARACTER */
  regionType?: CreateRegionBodyDtoRegionType;
}
