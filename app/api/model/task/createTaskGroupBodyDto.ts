 ...
 */
import type { CreateTaskGroupBodyDtoTaskType } from './createTaskGroupBodyDtoTaskType';

export interface CreateTaskGroupBodyDto {
  /**
   * Các trang cùng nhận một đầu việc (tối đa 50) — all-or-nothing
   * @minItems 1
   * @maxItems 50
   */
  pageIds: string[];
  ...
  taskType: CreateTaskGroupBodyDtoTaskType;
  /** Giai đoạn sản xuất đang mở của chapter */
  stageId?: string;
  /**
   * @minLength 1
   * @maxLength 2000
  ...
  description?: string;
  /**
   * Tên nhóm việc hiển thị, vd "Vẽ nền ch.5"
   * @minLength 1
   * @maxLength 200
   */
  groupTitle?: string;
