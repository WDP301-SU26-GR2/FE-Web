 ...
 */
import type { TaskBatchListResDtoOutputItemsItem } from './taskBatchListResDtoOutputItemsItem';

export interface TaskBatchListResDtoOutput {
  items: TaskBatchListResDtoOutputItemsItem[];
  total: number;
  limit: number;
  offset: number;
}
