 ...
 */
import type { TaskResDtoOutputAssetsItemAssetType } from './taskResDtoOutputAssetsItemAssetType';

export type TaskResDtoOutputAssetsItem = {
   ...
   * @nullable
   */
  assetType: TaskResDtoOutputAssetsItemAssetType;
};
