 ...
 */
export type TransferContractResDtoOutputSignaturesItemRole = typeof TransferContractResDtoOutputSignaturesItemRole[keyof typeof TransferContractResDtoOutputSignaturesItemRole];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TransferContractResDtoOutputSignaturesItemRole = {
  MANGAKA_A: 'MANGAKA_A',
  MANGAKA_B: 'MANGAKA_B',
  BOARD: 'BOARD',
} as const;
