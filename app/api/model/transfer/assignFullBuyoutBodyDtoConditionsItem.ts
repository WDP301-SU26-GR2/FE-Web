 ...
 */
import type { AssignFullBuyoutBodyDtoConditionsItemType } from './assignFullBuyoutBodyDtoConditionsItemType';

export type AssignFullBuyoutBodyDtoConditionsItem = {
  /** @minLength 1 */
  description: string;
  ...
  type: AssignFullBuyoutBodyDtoConditionsItemType;
  /**
   * @minimum 0
   * @exclusiveMinimum
   */
