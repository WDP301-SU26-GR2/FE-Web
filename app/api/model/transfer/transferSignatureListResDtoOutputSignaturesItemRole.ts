...
/**
 * Allowed values: MANGAKA_A, MANGAKA_B, BOARD. Values: MANGAKA_A, MANGAKA_B, BOARD
 */
export type TransferSignatureListResDtoOutputSignaturesItemRole = typeof TransferSignatureListResDtoOutputSignaturesItemRole[keyof typeof TransferSignatureListResDtoOutputSignaturesItemRole];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TransferSignatureListResDtoOutputSignaturesItemRole = {
  MANGAKA_A: 'MANGAKA_A',
  MANGAKA_B: 'MANGAKA_B',
  BOARD: 'BOARD',
} as const;
