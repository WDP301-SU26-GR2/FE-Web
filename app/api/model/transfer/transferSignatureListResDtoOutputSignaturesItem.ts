 ...
 */
import type { TransferSignatureListResDtoOutputSignaturesItemRole } from './transferSignatureListResDtoOutputSignaturesItemRole';

export type TransferSignatureListResDtoOutputSignaturesItem = {
  id: string;
  transferContractId: string;
  userId: string;
  /** Allowed values: MANGAKA_A, MANGAKA_B, BOARD. Values: MANGAKA_A, MANGAKA_B, BOARD */
  role: TransferSignatureListResDtoOutputSignaturesItemRole;
  /**
