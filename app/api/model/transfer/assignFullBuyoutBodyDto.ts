 ...
 */
import type { AssignFullBuyoutBodyDtoConditionsItem } from './assignFullBuyoutBodyDtoConditionsItem';

export interface AssignFullBuyoutBodyDto {
  /**
   * Deprecated compatibility field; ignored in favor of request.boardDecisionId
   * @minLength 1
   */
  ...
  /** @minItems 1 */
  conditions: AssignFullBuyoutBodyDtoConditionsItem[];
}
