 ...
 */
import type { CreateTransferRequestBodyDtoProposedType } from './createTransferRequestBodyDtoProposedType';

export interface CreateTransferRequestBodyDto {
  /** @minLength 1 */
  seriesId: string;
  /** @minLength 1 */
  ...
  proposedType: CreateTransferRequestBodyDtoProposedType;
  /**
   * @minimum 0
   * @maximum 100
   */
