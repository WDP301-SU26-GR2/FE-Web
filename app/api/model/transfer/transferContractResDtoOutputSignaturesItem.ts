 ...
 */
import type { TransferContractResDtoOutputSignaturesItemRole } from './transferContractResDtoOutputSignaturesItemRole';

export type TransferContractResDtoOutputSignaturesItem = {
  id: string;
  transferContractId: string;
  userId: string;
  /** Allowed values: MANGAKA_A, MANGAKA_B, BOARD. Values: MANGAKA_A, MANGAKA_B, BOARD */
  role: TransferContractResDtoOutputSignaturesItemRole;
  /**
