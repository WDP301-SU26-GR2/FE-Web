 ...
 */
import type { TransferSignatureListResDtoOutputSignaturesItem } from './transferSignatureListResDtoOutputSignaturesItem';

export interface TransferSignatureListResDtoOutput {
