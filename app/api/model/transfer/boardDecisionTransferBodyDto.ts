...
export interface BoardDecisionTransferBodyDto {
  /**
   * Quyết định TRANSFER terminal có thẩm quyền
   * @minLength 1
   */
  boardDecisionId?: string;
  /**
   * Deprecated: chỉ resolve khi phiên có đúng một quyết định TRANSFER terminal
   * @minLength 1
   */
