 ...
 */
import type { TransferRequestListResDtoOutputDataItem } from './transferRequestListResDtoOutputDataItem';

export interface TransferRequestListResDtoOutput {
  data: TransferRequestListResDtoOutputDataItem[];
}
