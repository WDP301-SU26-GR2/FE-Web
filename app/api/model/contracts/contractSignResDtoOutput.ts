 ...
 */
import type { ContractSignResDtoOutputContract } from './contractSignResDtoOutputContract';

export interface ContractSignResDtoOutput {
  status: string;
  message: string;
  /** @nullable */
  contract: ContractSignResDtoOutputContract;
}
