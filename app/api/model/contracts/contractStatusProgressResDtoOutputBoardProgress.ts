 ...
 */
import type { ContractStatusProgressResDtoOutputBoardProgressSignedEditorsItem } from './contractStatusProgressResDtoOutputBoardProgressSignedEditorsItem';
import type { ContractStatusProgressResDtoOutputBoardProgressPendingEditorsItem } from './contractStatusProgressResDtoOutputBoardProgressPendingEditorsItem';

export type ContractStatusProgressResDtoOutputBoardProgress = {
  totalRequired: number;
  totalSigned: number;
  signedEditors: ContractStatusProgressResDtoOutputBoardProgressSignedEditorsItem[];
  pendingEditors: ContractStatusProgressResDtoOutputBoardProgressPendingEditorsItem[];
};
