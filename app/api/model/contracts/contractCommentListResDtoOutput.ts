 ...
 */
import type { ContractCommentListResDtoOutputDataItem } from './contractCommentListResDtoOutputDataItem';

export interface ContractCommentListResDtoOutput {
  data: ContractCommentListResDtoOutputDataItem[];
}
