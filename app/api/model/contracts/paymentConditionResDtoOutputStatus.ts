 ...
 */
export type PaymentConditionResDtoOutputStatus = typeof PaymentConditionResDtoOutputStatus[keyof typeof PaymentConditionResDtoOutputStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PaymentConditionResDtoOutputStatus = {
  PENDING: 'PENDING',
  ACHIEVED: 'ACHIEVED',
  PAID: 'PAID',
  CANCELLED: 'CANCELLED',
