 ...
 */
import type { PaymentConditionResDtoOutputConditionType } from './paymentConditionResDtoOutputConditionType';
import type { PaymentConditionResDtoOutputThresholdConfig } from './paymentConditionResDtoOutputThresholdConfig';
import type { PaymentConditionResDtoOutputStatus } from './paymentConditionResDtoOutputStatus';
import type { PaymentConditionResDtoOutputAchievedAt } from './paymentConditionResDtoOutputAchievedAt';

export interface PaymentConditionResDtoOutput {
  id: string;
  contractId: string;
  conditionType: PaymentConditionResDtoOutputConditionType;
  /** @nullable */
  thresholdConfig: PaymentConditionResDtoOutputThresholdConfig;
  /** @nullable */
  payoutAmount: number | null;
  /** @nullable */
  payoutPct: number | null;
  isRecurring: boolean;
  status: PaymentConditionResDtoOutputStatus;
  /** @nullable */
  lastTriggeredValue: number | null;
  /** @nullable */
  achievedAt: PaymentConditionResDtoOutputAchievedAt;
}
