 ...
 */
import type { PaymentConditionListResDtoOutputDataItem } from './paymentConditionListResDtoOutputDataItem';

export interface PaymentConditionListResDtoOutput {
  data: PaymentConditionListResDtoOutputDataItem[];
}
