 ...
 */
import type { ContractCommentListResDtoOutputDataItemAuthor } from './contractCommentListResDtoOutputDataItemAuthor';

export type ContractCommentListResDtoOutputDataItem = {
  id: string;
  contractId: string;
  authorId: string;
  /** @nullable */
  author?: ContractCommentListResDtoOutputDataItemAuthor;
  content: string;
  /**
