 ...
 */
import type { ContractResDtoOutputBoardDecisionDecisionType } from './contractResDtoOutputBoardDecisionDecisionType';
import type { ContractResDtoOutputBoardDecisionResult } from './contractResDtoOutputBoardDecisionResult';
import type { ContractResDtoOutputBoardDecisionBoardSession } from './contractResDtoOutputBoardDecisionBoardSession';

/**
 * Căn cứ Board Decision và phiên họp nguồn; có ở GET list/detail
 * @nullable
 */
export type ContractResDtoOutputBoardDecision = {
  id: string;
  /**
   ...
   * @nullable
   */
  decisionType: ContractResDtoOutputBoardDecisionDecisionType;
  /**
   ...
   * @nullable
   */
  result: ContractResDtoOutputBoardDecisionResult;
  /**
  ...
  boardSession: ContractResDtoOutputBoardDecisionBoardSession;
} | null;
