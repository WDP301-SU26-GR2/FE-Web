 ...
 */
import type { ContractStatusProgressResDtoOutputMangakaSignedAt } from './contractStatusProgressResDtoOutputMangakaSignedAt';

export type ContractStatusProgressResDtoOutputMangaka = {
  id: string;
  isSigned: boolean;
  /** @nullable */
  signedAt: ContractStatusProgressResDtoOutputMangakaSignedAt;
};
