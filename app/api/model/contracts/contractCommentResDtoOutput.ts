 ...
 */
import type { ContractCommentResDtoOutputAuthor } from './contractCommentResDtoOutputAuthor';

export interface ContractCommentResDtoOutput {
  id: string;
  contractId: string;
  authorId: string;
  /** @nullable */
  author?: ContractCommentResDtoOutputAuthor;
  content: string;
  /**
