 ...
 */
import type { AmendmentResDtoOutputSignaturesItemRole } from './amendmentResDtoOutputSignaturesItemRole';

export type AmendmentResDtoOutputSignaturesItem = {
  id: string;
  amendmentId: string;
  userId: string;
  /** Allowed values: BOARD_MEMBER. Values: BOARD_MEMBER */
  role: AmendmentResDtoOutputSignaturesItemRole;
  /**
