 ...
 * Nhịp phát hành
 */
export type UpdateSeriesSlotBodyDtoPublicationType = typeof UpdateSeriesSlotBodyDtoPublicationType[keyof typeof UpdateSeriesSlotBodyDtoPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateSeriesSlotBodyDtoPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
