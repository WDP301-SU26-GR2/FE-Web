 ...
 */
import type { UpdateSeriesSlotBodyDtoPublicationType } from './updateSeriesSlotBodyDtoPublicationType';

export interface UpdateSeriesSlotBodyDto {
  /** Tên tạp chí (sau normalize) */
  magazine?: string;
  /**
   * Số kỳ bắt đầu
   * @minimum 0
  ...
  /** Nhịp phát hành */
  publicationType?: UpdateSeriesSlotBodyDtoPublicationType;
}
