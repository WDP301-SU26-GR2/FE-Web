 ...
 */
import type { ChapterListResDtoOutputItemsItem } from './chapterListResDtoOutputItemsItem';

export interface ChapterListResDtoOutput {
  items: ChapterListResDtoOutputItemsItem[];
}
