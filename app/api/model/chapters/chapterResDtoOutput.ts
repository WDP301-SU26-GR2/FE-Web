 ...
 */
import type { ChapterResDtoOutputStatus } from './chapterResDtoOutputStatus';
import type { ChapterResDtoOutputHold } from './chapterResDtoOutputHold';
import type { ChapterResDtoOutputManuscriptStatus } from './chapterResDtoOutputManuscriptStatus';
import type { ChapterResDtoOutputSchedule } from './chapterResDtoOutputSchedule';

export interface ChapterResDtoOutput {
  id: string;
  seriesId: string;
  /** @nullable */
  nameId: string | null;
  ...
  status: ChapterResDtoOutputStatus;
  /**
