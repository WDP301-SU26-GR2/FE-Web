 ...
 */
export type ChapterProgressResDtoOutputCurrentStageStatus = typeof ChapterProgressResDtoOutputCurrentStageStatus[keyof typeof ChapterProgressResDtoOutputCurrentStageStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ChapterProgressResDtoOutputCurrentStageStatus = {
  LOCKED: 'LOCKED',
  ACTIVE: 'ACTIVE',
  COMPLETED: 'COMPLETED',
} as const;
