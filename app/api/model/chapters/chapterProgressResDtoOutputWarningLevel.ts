 ...
 */
export type ChapterProgressResDtoOutputWarningLevel = typeof ChapterProgressResDtoOutputWarningLevel[keyof typeof ChapterProgressResDtoOutputWarningLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ChapterProgressResDtoOutputWarningLevel = {
  NONE: 'NONE',
  YELLOW: 'YELLOW',
  RED: 'RED',
  CRITICAL: 'CRITICAL',
