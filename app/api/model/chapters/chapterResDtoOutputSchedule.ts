 ...
 */
import type { ChapterResDtoOutputScheduleExtensionsItem } from './chapterResDtoOutputScheduleExtensionsItem';

/**
 * @nullable
 */
export type ChapterResDtoOutputSchedule = {
  id: string;
  chapterId: string;
  /** @nullable */
  ...
  extended: boolean;
  extensions: ChapterResDtoOutputScheduleExtensionsItem[];
} | null;
