 ...
 */
import type { ChapterListResDtoOutputItemsItemScheduleExtensionsItem } from './chapterListResDtoOutputItemsItemScheduleExtensionsItem';

/**
 * @nullable
 */
export type ChapterListResDtoOutputItemsItemSchedule = {
  id: string;
  chapterId: string;
  /** @nullable */
  ...
  extended: boolean;
  extensions: ChapterListResDtoOutputItemsItemScheduleExtensionsItem[];
} | null;
