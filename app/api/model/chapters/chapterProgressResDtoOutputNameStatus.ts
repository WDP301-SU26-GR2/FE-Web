 ...
 * @nullable
 */
export type ChapterProgressResDtoOutputNameStatus = typeof ChapterProgressResDtoOutputNameStatus[keyof typeof ChapterProgressResDtoOutputNameStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ChapterProgressResDtoOutputNameStatus = {
  DRAFT: 'DRAFT',
  SUBMITTED: 'SUBMITTED',
  IN_REVIEW: 'IN_REVIEW',
  REVISION: 'REVISION',
