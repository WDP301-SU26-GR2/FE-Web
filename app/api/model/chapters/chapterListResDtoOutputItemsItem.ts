 ...
 */
import type { ChapterListResDtoOutputItemsItemStatus } from './chapterListResDtoOutputItemsItemStatus';
import type { ChapterListResDtoOutputItemsItemHold } from './chapterListResDtoOutputItemsItemHold';
import type { ChapterListResDtoOutputItemsItemManuscriptStatus } from './chapterListResDtoOutputItemsItemManuscriptStatus';
import type { ChapterListResDtoOutputItemsItemSchedule } from './chapterListResDtoOutputItemsItemSchedule';

export type ChapterListResDtoOutputItemsItem = {
  id: string;
  seriesId: string;
  /** @nullable */
  nameId: string | null;
  ...
  /** Chapter production status. Values: DRAFT, IN_PRODUCTION, COMPLETED, PUBLISHED */
  status: ChapterListResDtoOutputItemsItemStatus;
  /**
   * ISO 8601; null khi chưa xuất bản
   * @nullable
   */
  publishedAt: string | null;
  /**
   * null = chapter is not on hold
   * @nullable
   */
