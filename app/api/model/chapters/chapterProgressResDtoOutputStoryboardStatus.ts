 ...
 * @nullable
 */
export type ChapterProgressResDtoOutputStoryboardStatus = typeof ChapterProgressResDtoOutputStoryboardStatus[keyof typeof ChapterProgressResDtoOutputStoryboardStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ChapterProgressResDtoOutputStoryboardStatus = {
  DRAFT: 'DRAFT',
  SUBMITTED: 'SUBMITTED',
  IN_REVIEW: 'IN_REVIEW',
  REVISION: 'REVISION',
