 ...
 */
import type { ChapterProgressResDtoOutputCurrentStageStatus } from './chapterProgressResDtoOutputCurrentStageStatus';

/**
 * @nullable
 */
export type ChapterProgressResDtoOutputCurrentStage = {
  id: string;
  name: string;
  /**
  ...
  status: ChapterProgressResDtoOutputCurrentStageStatus;
} | null;
