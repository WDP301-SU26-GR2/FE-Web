...
export type PaymentControllerGetPaymentsPaymentSource = typeof PaymentControllerGetPaymentsPaymentSource[keyof typeof PaymentControllerGetPaymentsPaymentSource];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PaymentControllerGetPaymentsPaymentSource = {
  CONTRACT: 'CONTRACT',
  REPRINT: 'REPRINT',
  TRANSFER: 'TRANSFER',
