 ...
 */
import type { PaymentRecordListResDtoOutputDataItem } from './paymentRecordListResDtoOutputDataItem';

export interface PaymentRecordListResDtoOutput {
  data: PaymentRecordListResDtoOutputDataItem[];
}
