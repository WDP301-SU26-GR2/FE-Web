...
import type { PaymentRecordResDtoOutputApprover } from './paymentRecordResDtoOutputApprover';
...
export interface PaymentRecordResDtoOutput {
  ...
  createdAt: string;
  /** @nullable */
  series?: PaymentRecordResDtoOutputSeries;
  receiver?: PaymentRecordResDtoOutputReceiver;
  /**
   * Nguoi duyet chi (approvedBy); null neu chua duyet
   * @nullable
   */
  approver?: PaymentRecordResDtoOutputApprover;
}
