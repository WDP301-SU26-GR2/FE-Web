...
export type PaymentRecordListResDtoOutputDataItemPaymentSource = typeof PaymentRecordListResDtoOutputDataItemPaymentSource[keyof typeof PaymentRecordListResDtoOutputDataItemPaymentSource];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PaymentRecordListResDtoOutputDataItemPaymentSource = {
  CONTRACT: 'CONTRACT',
  REPRINT: 'REPRINT',
  TRANSFER: 'TRANSFER',
