...
export type PaymentRecordListResDtoOutputDataItemStatus = typeof PaymentRecordListResDtoOutputDataItemStatus[keyof typeof PaymentRecordListResDtoOutputDataItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PaymentRecordListResDtoOutputDataItemStatus = {
  TRIGGERED: 'TRIGGERED',
  MISSED: 'MISSED',
  PENDING: 'PENDING',
  APPROVED: 'APPROVED',
