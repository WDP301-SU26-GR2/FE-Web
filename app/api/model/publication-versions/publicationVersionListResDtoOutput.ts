 ...
 */
import type { PublicationVersionListResDtoOutputItemsItem } from './publicationVersionListResDtoOutputItemsItem';

export interface PublicationVersionListResDtoOutput {
  items: PublicationVersionListResDtoOutputItemsItem[];
}
