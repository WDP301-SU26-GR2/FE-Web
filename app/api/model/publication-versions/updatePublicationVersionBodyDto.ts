 ...
 */
import type { UpdatePublicationVersionBodyDtoReadingDirection } from './updatePublicationVersionBodyDtoReadingDirection';
import type { UpdatePublicationVersionBodyDtoVersionType } from './updatePublicationVersionBodyDtoVersionType';

export interface UpdatePublicationVersionBodyDto {
  /**
   * @minLength 1
   * @maxLength 20
   * @nullable
