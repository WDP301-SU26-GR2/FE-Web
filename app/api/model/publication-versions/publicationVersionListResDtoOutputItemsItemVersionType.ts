 ...
 * @nullable
 */
export type PublicationVersionListResDtoOutputItemsItemVersionType = typeof PublicationVersionListResDtoOutputItemsItemVersionType[keyof typeof PublicationVersionListResDtoOutputItemsItemVersionType] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicationVersionListResDtoOutputItemsItemVersionType = {
  ORIGINAL: 'ORIGINAL',
  DIGITAL: 'DIGITAL',
  FLIPPED: 'FLIPPED',
} as const;
