 ...
 */
export type InviteListResDtoOutputItemsItemStatus = typeof InviteListResDtoOutputItemsItemStatus[keyof typeof InviteListResDtoOutputItemsItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const InviteListResDtoOutputItemsItemStatus = {
  PENDING: 'PENDING',
  ACCEPTED: 'ACCEPTED',
  DECLINED: 'DECLINED',
  EXPIRED: 'EXPIRED',
