...
export type StudioControllerListInvitesStatus = typeof StudioControllerListInvitesStatus[keyof typeof StudioControllerListInvitesStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const StudioControllerListInvitesStatus = {
  PENDING: 'PENDING',
  ACCEPTED: 'ACCEPTED',
  DECLINED: 'DECLINED',
  EXPIRED: 'EXPIRED',
