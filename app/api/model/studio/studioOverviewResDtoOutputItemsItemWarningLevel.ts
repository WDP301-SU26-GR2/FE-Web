 ...
 */
export type StudioOverviewResDtoOutputItemsItemWarningLevel = typeof StudioOverviewResDtoOutputItemsItemWarningLevel[keyof typeof StudioOverviewResDtoOutputItemsItemWarningLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const StudioOverviewResDtoOutputItemsItemWarningLevel = {
  NONE: 'NONE',
  YELLOW: 'YELLOW',
  RED: 'RED',
  CRITICAL: 'CRITICAL',
