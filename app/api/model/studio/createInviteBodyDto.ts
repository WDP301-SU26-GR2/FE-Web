 ...
 */
import type { CreateInviteBodyDtoTaskTypesItem } from './createInviteBodyDtoTaskTypesItem';

export interface CreateInviteBodyDto {
  assistantId: string;
  /** metadata; A4-a KHÔNG validate series tồn tại/sở hữu */
  seriesId?: string;
  ...
  hireEnd: string;
  /** @minItems 1 */
  taskTypes: CreateInviteBodyDtoTaskTypesItem[];
}
