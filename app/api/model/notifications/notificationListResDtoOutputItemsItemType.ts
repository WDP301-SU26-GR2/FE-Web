 ...
 * @nullable
 */
export type NotificationListResDtoOutputItemsItemType = typeof NotificationListResDtoOutputItemsItemType[keyof typeof NotificationListResDtoOutputItemsItemType] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NotificationListResDtoOutputItemsItemType = {
  SYSTEM: 'SYSTEM',
  CONTRACT: 'CONTRACT',
  TASK: 'TASK',
  DEADLINE: 'DEADLINE',
