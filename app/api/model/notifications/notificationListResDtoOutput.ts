 ...
 */
import type { NotificationListResDtoOutputItemsItem } from './notificationListResDtoOutputItemsItem';

export interface NotificationListResDtoOutput {
  items: NotificationListResDtoOutputItemsItem[];
  total: number;
  /** Tổng số chưa đọc (độc lập filter, dùng cho badge) */
  unreadCount: number;
  limit: number;
  offset: number;
}
