...
export type NotificationControllerListType = typeof NotificationControllerListType[keyof typeof NotificationControllerListType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NotificationControllerListType = {
  SYSTEM: 'SYSTEM',
  CONTRACT: 'CONTRACT',
  TASK: 'TASK',
  DEADLINE: 'DEADLINE',
