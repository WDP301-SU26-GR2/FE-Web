...
/**
 * Board quyết định: APPROVE → cập nhật Schedule; REJECT → giữ nguyên
 */
export type BoardResolveBodyDtoDecision = typeof BoardResolveBodyDtoDecision[keyof typeof BoardResolveBodyDtoDecision];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const BoardResolveBodyDtoDecision = {
  APPROVE: 'APPROVE',
  REJECT: 'REJECT',
} as const;
