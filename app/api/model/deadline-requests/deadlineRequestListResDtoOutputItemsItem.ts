...
export type DeadlineRequestListResDtoOutputItemsItem = {
  id: string;
  scheduleId: string;
  /** @nullable */
  ...
  status: DeadlineRequestListResDtoOutputItemsItemStatus;
  /** @nullable */
   ...
   * @nullable
   */
  series?: DeadlineRequestListResDtoOutputItemsItemSeries;
  /**
   * Thông tin chương — có ở GET list/detail
   * @nullable
   */
  chapter?: DeadlineRequestListResDtoOutputItemsItemChapter;
};
