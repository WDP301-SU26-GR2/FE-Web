 ...
 */
import type { PublicMagazineListResDtoOutputItemsItemPublicationTypesItem } from './publicMagazineListResDtoOutputItemsItemPublicationTypesItem';

export type PublicMagazineListResDtoOutputItemsItem = {
  name: string;
  publicationTypes: PublicMagazineListResDtoOutputItemsItemPublicationTypesItem[];
};
