...
export type PublicControllerListSeriesPublicationType = typeof PublicControllerListSeriesPublicationType[keyof typeof PublicControllerListSeriesPublicationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicControllerListSeriesPublicationType = {
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  IRREGULAR: 'IRREGULAR',
} as const;
