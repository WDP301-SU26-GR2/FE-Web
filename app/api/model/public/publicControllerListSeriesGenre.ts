...
export type PublicControllerListSeriesGenre = typeof PublicControllerListSeriesGenre[keyof typeof PublicControllerListSeriesGenre];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicControllerListSeriesGenre = {
  ACTION: 'ACTION',
  ADVENTURE: 'ADVENTURE',
  COMEDY: 'COMEDY',
  DRAMA: 'DRAMA',
