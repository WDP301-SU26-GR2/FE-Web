...
export type PublicControllerListSeriesDemographic = typeof PublicControllerListSeriesDemographic[keyof typeof PublicControllerListSeriesDemographic];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicControllerListSeriesDemographic = {
  SHONEN: 'SHONEN',
  SEINEN: 'SEINEN',
  SHOJO: 'SHOJO',
  JOSEI: 'JOSEI',
