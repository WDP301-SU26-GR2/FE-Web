 ...
 */
import type { PublicChapterPagesResDtoOutputSeries } from './publicChapterPagesResDtoOutputSeries';
import type { PublicChapterPagesResDtoOutputChapter } from './publicChapterPagesResDtoOutputChapter';
import type { PublicChapterPagesResDtoOutputPagesItem } from './publicChapterPagesResDtoOutputPagesItem';

export interface PublicChapterPagesResDtoOutput {
  series: PublicChapterPagesResDtoOutputSeries;
  chapter: PublicChapterPagesResDtoOutputChapter;
  pages: PublicChapterPagesResDtoOutputPagesItem[];
  /**
   * Previous PUBLISHED chapter by chapterNumber
   * @nullable
   */
  prevChapterId: string | null;
  /**
   * Next PUBLISHED chapter by chapterNumber
   * @nullable
   */
