 ...
 */
import type { PublicSeriesListResDtoOutputItemsItemGenresItem } from './publicSeriesListResDtoOutputItemsItemGenresItem';
import type { PublicSeriesListResDtoOutputItemsItemDemographic } from './publicSeriesListResDtoOutputItemsItemDemographic';
import type { PublicSeriesListResDtoOutputItemsItemStatus } from './publicSeriesListResDtoOutputItemsItemStatus';
import type { PublicSeriesListResDtoOutputItemsItemPublicationType } from './publicSeriesListResDtoOutputItemsItemPublicationType';
import type { PublicSeriesListResDtoOutputItemsItemAuthor } from './publicSeriesListResDtoOutputItemsItemAuthor';

export type PublicSeriesListResDtoOutputItemsItem = {
  id: string;
  title: string;
  /**
  ...
  genres: PublicSeriesListResDtoOutputItemsItemGenresItem[];
  /**
   * Phân khúc độc giả: SHONEN, SEINEN, SHOJO, JOSEI, KODOMO. Values: SHONEN, SEINEN, SHOJO, JOSEI, KODOMO
   * @nullable
   */
  demographic: PublicSeriesListResDtoOutputItemsItemDemographic;
  ...
  status: PublicSeriesListResDtoOutputItemsItemStatus;
  /**
   * Publication cadence: WEEKLY, MONTHLY, IRREGULAR. Values: WEEKLY, MONTHLY, IRREGULAR
   * @nullable
   */
  publicationType: PublicSeriesListResDtoOutputItemsItemPublicationType;
  /** @nullable */
  magazine: string | null;
  author: PublicSeriesListResDtoOutputItemsItemAuthor;
  /**
