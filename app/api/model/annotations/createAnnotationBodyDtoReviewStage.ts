 ...
 */
export type CreateAnnotationBodyDtoReviewStage = typeof CreateAnnotationBodyDtoReviewStage[keyof typeof CreateAnnotationBodyDtoReviewStage];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateAnnotationBodyDtoReviewStage = {
  ASSISTANT: 'ASSISTANT',
  MANGAKA: 'MANGAKA',
  EDITOR: 'EDITOR',
} as const;
