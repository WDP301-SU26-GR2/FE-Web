 ...
 * @nullable
 */
export type AnnotationListResDtoOutputItemsItemAnnotationType = typeof AnnotationListResDtoOutputItemsItemAnnotationType[keyof typeof AnnotationListResDtoOutputItemsItemAnnotationType] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AnnotationListResDtoOutputItemsItemAnnotationType = {
  TEXT: 'TEXT',
  HIGHLIGHT: 'HIGHLIGHT',
  DRAWING: 'DRAWING',
} as const;
