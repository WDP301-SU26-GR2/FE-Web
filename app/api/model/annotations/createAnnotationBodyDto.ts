 ...
 */
import type { CreateAnnotationBodyDtoTargetType } from './createAnnotationBodyDtoTargetType';
import type { CreateAnnotationBodyDtoAnnotationType } from './createAnnotationBodyDtoAnnotationType';
import type { CreateAnnotationBodyDtoCoordinates } from './createAnnotationBodyDtoCoordinates';
...
export interface CreateAnnotationBodyDto {
  ...
  annotationType: CreateAnnotationBodyDtoAnnotationType;
  coordinates?: CreateAnnotationBodyDtoCoordinates;
  /** @maxLength 5000 */
  content?: string;
  /** Review stage: ASSISTANT, MANGAKA, EDITOR. Values: ASSISTANT, MANGAKA, EDITOR */
  reviewStage?: CreateAnnotationBodyDtoReviewStage;
  taskId?: string;
}
