 ...
 */
export type CreateAnnotationBodyDtoAnnotationType = typeof CreateAnnotationBodyDtoAnnotationType[keyof typeof CreateAnnotationBodyDtoAnnotationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateAnnotationBodyDtoAnnotationType = {
  TEXT: 'TEXT',
  HIGHLIGHT: 'HIGHLIGHT',
  DRAWING: 'DRAWING',
} as const;
