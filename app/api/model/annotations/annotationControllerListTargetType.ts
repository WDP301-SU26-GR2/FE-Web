...
export type AnnotationControllerListTargetType = typeof AnnotationControllerListTargetType[keyof typeof AnnotationControllerListTargetType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AnnotationControllerListTargetType = {
  PAGE: 'PAGE',
  REGION: 'REGION',
  TASK: 'TASK',
