 ...
 */
import type { AnnotationListResDtoOutputItemsItem } from './annotationListResDtoOutputItemsItem';

export interface AnnotationListResDtoOutput {
  items: AnnotationListResDtoOutputItemsItem[];
}
