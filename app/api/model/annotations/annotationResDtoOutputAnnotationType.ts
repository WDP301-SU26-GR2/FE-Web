 ...
 * @nullable
 */
export type AnnotationResDtoOutputAnnotationType = typeof AnnotationResDtoOutputAnnotationType[keyof typeof AnnotationResDtoOutputAnnotationType] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AnnotationResDtoOutputAnnotationType = {
  TEXT: 'TEXT',
  HIGHLIGHT: 'HIGHLIGHT',
  DRAWING: 'DRAWING',
} as const;
