 ...
 */
import type { StoryboardListResDtoOutputItemsItem } from './storyboardListResDtoOutputItemsItem';

export interface StoryboardListResDtoOutput {
  items: StoryboardListResDtoOutputItemsItem[];
}
