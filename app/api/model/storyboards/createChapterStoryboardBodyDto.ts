 ...
 */
import type { CreateChapterStoryboardBodyDtoStoryboardPagesItem } from './createChapterStoryboardBodyDtoStoryboardPagesItem';

export interface CreateChapterStoryboardBodyDto {
  /** @minItems 1 */
  storyboardPages: CreateChapterStoryboardBodyDtoStoryboardPagesItem[];
}
