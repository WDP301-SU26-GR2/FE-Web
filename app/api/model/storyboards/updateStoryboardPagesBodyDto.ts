 ...
 */
import type { UpdateStoryboardPagesBodyDtoPagesItem } from './updateStoryboardPagesBodyDtoPagesItem';

export interface UpdateStoryboardPagesBodyDto {
  pages: UpdateStoryboardPagesBodyDtoPagesItem[];
}
