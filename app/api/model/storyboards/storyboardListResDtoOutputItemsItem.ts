 ...
 */
import type { StoryboardListResDtoOutputItemsItemStatus } from './storyboardListResDtoOutputItemsItemStatus';
import type { StoryboardListResDtoOutputItemsItemPagesItem } from './storyboardListResDtoOutputItemsItemPagesItem';

export type StoryboardListResDtoOutputItemsItem = {
  id: string;
  seriesId: string;
  ...
  status: StoryboardListResDtoOutputItemsItemStatus;
  /** Tăng mỗi lần resubmit */
  version: number;
  /** Các trang vẽ thô; fileUrl là object key (R2) */
  pages: StoryboardListResDtoOutputItemsItemPagesItem[];
  /**
