 ...
 */
export type StoryboardResDtoOutputStatus = typeof StoryboardResDtoOutputStatus[keyof typeof StoryboardResDtoOutputStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const StoryboardResDtoOutputStatus = {
  DRAFT: 'DRAFT',
  SUBMITTED: 'SUBMITTED',
  IN_REVIEW: 'IN_REVIEW',
  REVISION: 'REVISION',
