 ...
 */
import type { CreateChapterNameBodyDtoNamePagesItem } from './createChapterNameBodyDtoNamePagesItem';

export interface CreateChapterNameBodyDto {
  /** @minItems 1 */
  namePages: CreateChapterNameBodyDtoNamePagesItem[];
}
