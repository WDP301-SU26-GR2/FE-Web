 ...
 */
export type NameListResDtoOutputItemsItemKind = typeof NameListResDtoOutputItemsItemKind[keyof typeof NameListResDtoOutputItemsItemKind];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NameListResDtoOutputItemsItemKind = {
  PROPOSAL: 'PROPOSAL',
  CHAPTER: 'CHAPTER',
} as const;
