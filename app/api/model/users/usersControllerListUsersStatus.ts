...
export type UsersControllerListUsersStatus = typeof UsersControllerListUsersStatus[keyof typeof UsersControllerListUsersStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UsersControllerListUsersStatus = {
  INACTIVE: 'INACTIVE',
  ACTIVE: 'ACTIVE',
  BANNED: 'BANNED',
  BLOCKED: 'BLOCKED',
