 ...
 */
export type AdminUpdateUserStatusBodyDtoStatus = typeof AdminUpdateUserStatusBodyDtoStatus[keyof typeof AdminUpdateUserStatusBodyDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AdminUpdateUserStatusBodyDtoStatus = {
  ACTIVE: 'ACTIVE',
  BANNED: 'BANNED',
  BLOCKED: 'BLOCKED',
} as const;
