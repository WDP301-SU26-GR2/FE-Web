 ...
 */
import type { AdminStatsResDtoOutputTasksByStatus } from './adminStatsResDtoOutputTasksByStatus';

export type AdminStatsResDtoOutputTasks = {
  total: number;
  byStatus: AdminStatsResDtoOutputTasksByStatus;
};
