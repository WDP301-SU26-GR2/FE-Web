 ...
 */
export type AdminCreateUserResDtoOutputRoleCode = typeof AdminCreateUserResDtoOutputRoleCode[keyof typeof AdminCreateUserResDtoOutputRoleCode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AdminCreateUserResDtoOutputRoleCode = {
  MANGAKA: 'MANGAKA',
  ASSISTANT: 'ASSISTANT',
  EDITOR: 'EDITOR',
