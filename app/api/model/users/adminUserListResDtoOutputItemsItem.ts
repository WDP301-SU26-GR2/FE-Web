 ...
 */
import type { AdminUserListResDtoOutputItemsItemRole } from './adminUserListResDtoOutputItemsItemRole';
import type { AdminUserListResDtoOutputItemsItemStatus } from './adminUserListResDtoOutputItemsItemStatus';
import type { AdminUserListResDtoOutputItemsItemRegistrationType } from './adminUserListResDtoOutputItemsItemRegistrationType';

export type AdminUserListResDtoOutputItemsItem = {
  id: string;
  email: string;
  name: string;
  /** @nullable */
  ...
  role: AdminUserListResDtoOutputItemsItemRole;
  /** User lifecycle status: INACTIVE, ACTIVE, BANNED, BLOCKED. Values: INACTIVE, ACTIVE, BANNED, BLOCKED */
  status: AdminUserListResDtoOutputItemsItemStatus;
  emailVerified: boolean;
  /** How the account was created: SELF_REGISTERED or ADMIN_CREATED. Values: SELF_REGISTERED, ADMIN_CREATED */
  registrationType: AdminUserListResDtoOutputItemsItemRegistrationType;
