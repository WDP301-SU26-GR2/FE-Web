 ...
 */
import type { AdminUserResDtoOutputRole } from './adminUserResDtoOutputRole';
import type { AdminUserResDtoOutputStatus } from './adminUserResDtoOutputStatus';
import type { AdminUserResDtoOutputRegistrationType } from './adminUserResDtoOutputRegistrationType';

export interface AdminUserResDtoOutput {
  id: string;
  email: string;
  name: string;
  /** @nullable */
