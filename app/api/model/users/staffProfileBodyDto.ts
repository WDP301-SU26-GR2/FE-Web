 ...
 */
import type { StaffProfileBodyDtoSpecialtyGenresItem } from './staffProfileBodyDtoSpecialtyGenresItem';
import type { StaffProfileBodyDtoDemographicsItem } from './staffProfileBodyDtoDemographicsItem';

export interface StaffProfileBodyDto {
  /** Sở trường thể loại — dùng để auto-assign Board vào phiên pitch (PB-05) */
  specialtyGenres?: StaffProfileBodyDtoSpecialtyGenresItem[];
  demographics?: StaffProfileBodyDtoDemographicsItem[];
  /** @maxLength 2000 */
  bio?: string;
  /**
   * @minimum 0
