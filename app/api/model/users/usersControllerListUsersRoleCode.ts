...
export type UsersControllerListUsersRoleCode = typeof UsersControllerListUsersRoleCode[keyof typeof UsersControllerListUsersRoleCode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UsersControllerListUsersRoleCode = {
  MANGAKA: 'MANGAKA',
  ASSISTANT: 'ASSISTANT',
  EDITOR: 'EDITOR',
