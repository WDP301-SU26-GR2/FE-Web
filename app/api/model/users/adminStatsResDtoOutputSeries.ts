 ...
 */
import type { AdminStatsResDtoOutputSeriesByStatus } from './adminStatsResDtoOutputSeriesByStatus';

export type AdminStatsResDtoOutputSeries = {
  total: number;
  byStatus: AdminStatsResDtoOutputSeriesByStatus;
};
