 ...
 */
import type { StaffProfileResDtoOutputRole } from './staffProfileResDtoOutputRole';
import type { StaffProfileResDtoOutputSpecialtyGenresItem } from './staffProfileResDtoOutputSpecialtyGenresItem';
import type { StaffProfileResDtoOutputDemographicsItem } from './staffProfileResDtoOutputDemographicsItem';

export interface StaffProfileResDtoOutput {
  userId: string;
  ...
  role: StaffProfileResDtoOutputRole;
  specialtyGenres: StaffProfileResDtoOutputSpecialtyGenresItem[];
  demographics: StaffProfileResDtoOutputDemographicsItem[];
  /** @nullable */
  bio: string | null;
  /** @nullable */
  ...
  /** @nullable */
  avatar: string | null;
  /** false = chưa build hồ sơ; field profile = default rỗng */
  hasProfile: boolean;
}
