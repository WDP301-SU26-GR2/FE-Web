 ...
 */
export type MangakaProfileBodyDtoGenresItem = typeof MangakaProfileBodyDtoGenresItem[keyof typeof MangakaProfileBodyDtoGenresItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MangakaProfileBodyDtoGenresItem = {
  ACTION: 'ACTION',
  ADVENTURE: 'ADVENTURE',
  COMEDY: 'COMEDY',
  DRAMA: 'DRAMA',
