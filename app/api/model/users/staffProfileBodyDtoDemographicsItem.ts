 ...
 */
export type StaffProfileBodyDtoDemographicsItem = typeof StaffProfileBodyDtoDemographicsItem[keyof typeof StaffProfileBodyDtoDemographicsItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const StaffProfileBodyDtoDemographicsItem = {
  SHONEN: 'SHONEN',
  SEINEN: 'SEINEN',
  SHOJO: 'SHOJO',
  JOSEI: 'JOSEI',
