...
export type UsersControllerListMangakasGenre = typeof UsersControllerListMangakasGenre[keyof typeof UsersControllerListMangakasGenre];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UsersControllerListMangakasGenre = {
  ACTION: 'ACTION',
  ADVENTURE: 'ADVENTURE',
  COMEDY: 'COMEDY',
  DRAMA: 'DRAMA',
