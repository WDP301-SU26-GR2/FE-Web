 ...
 */
export type AdminUserResDtoOutputStatus = typeof AdminUserResDtoOutputStatus[keyof typeof AdminUserResDtoOutputStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AdminUserResDtoOutputStatus = {
  INACTIVE: 'INACTIVE',
  ACTIVE: 'ACTIVE',
  BANNED: 'BANNED',
  BLOCKED: 'BLOCKED',
