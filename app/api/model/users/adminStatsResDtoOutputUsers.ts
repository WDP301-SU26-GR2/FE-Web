 ...
 */
import type { AdminStatsResDtoOutputUsersByStatus } from './adminStatsResDtoOutputUsersByStatus';
import type { AdminStatsResDtoOutputUsersByRole } from './adminStatsResDtoOutputUsersByRole';

export type AdminStatsResDtoOutputUsers = {
  /** Users not soft-deleted */
  total: number;
  /** Soft-deleted users */
  deleted: number;
  byStatus: AdminStatsResDtoOutputUsersByStatus;
  byRole: AdminStatsResDtoOutputUsersByRole;
};
