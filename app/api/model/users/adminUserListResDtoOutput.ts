 ...
 */
import type { AdminUserListResDtoOutputItemsItem } from './adminUserListResDtoOutputItemsItem';

export interface AdminUserListResDtoOutput {
  items: AdminUserListResDtoOutputItemsItem[];
  total: number;
  limit: number;
  offset: number;
}
