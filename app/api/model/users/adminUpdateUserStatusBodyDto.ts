 ...
 */
import type { AdminUpdateUserStatusBodyDtoStatus } from './adminUpdateUserStatusBodyDtoStatus';

export interface AdminUpdateUserStatusBodyDto {
  /** Allowed status changes: ACTIVE, BANNED, BLOCKED. INACTIVE is not allowed (pre-verify state). */
  status: AdminUpdateUserStatusBodyDtoStatus;
  /**
   * Ban/block reason — included in the notification sent to the user
   * @minLength 1
   */
  reason?: string;
}
