 ...
 */
export type StaffProfileResDtoOutputDemographicsItem = typeof StaffProfileResDtoOutputDemographicsItem[keyof typeof StaffProfileResDtoOutputDemographicsItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const StaffProfileResDtoOutputDemographicsItem = {
  SHONEN: 'SHONEN',
  SEINEN: 'SEINEN',
  SHOJO: 'SHOJO',
  JOSEI: 'JOSEI',
