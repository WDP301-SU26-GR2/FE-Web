 ...
 */
import type { AssistantDirectoryListResDtoOutputItemsItem } from './assistantDirectoryListResDtoOutputItemsItem';

export interface AssistantDirectoryListResDtoOutput {
