 ...
 */
export type AdminUserListResDtoOutputItemsItemStatus = typeof AdminUserListResDtoOutputItemsItemStatus[keyof typeof AdminUserListResDtoOutputItemsItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AdminUserListResDtoOutputItemsItemStatus = {
  INACTIVE: 'INACTIVE',
  ACTIVE: 'ACTIVE',
  BANNED: 'BANNED',
  BLOCKED: 'BLOCKED',
