 ...
 */
export type AssistantProfileBodyDtoExperienceLevel = typeof AssistantProfileBodyDtoExperienceLevel[keyof typeof AssistantProfileBodyDtoExperienceLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AssistantProfileBodyDtoExperienceLevel = {
  JUNIOR: 'JUNIOR',
  MID: 'MID',
  SENIOR: 'SENIOR',
} as const;
