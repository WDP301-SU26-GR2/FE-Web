 ...
 */
import type { AdminStatsResDtoOutputUsers } from './adminStatsResDtoOutputUsers';
import type { AdminStatsResDtoOutputSeries } from './adminStatsResDtoOutputSeries';
import type { AdminStatsResDtoOutputChapters } from './adminStatsResDtoOutputChapters';
import type { AdminStatsResDtoOutputTasks } from './adminStatsResDtoOutputTasks';

export interface AdminStatsResDtoOutput {
  users: AdminStatsResDtoOutputUsers;
  series: AdminStatsResDtoOutputSeries;
  chapters: AdminStatsResDtoOutputChapters;
  tasks: AdminStatsResDtoOutputTasks;
}
