 ...
 */
export type AiJobListResDtoOutputItemsItemStatus = typeof AiJobListResDtoOutputItemsItemStatus[keyof typeof AiJobListResDtoOutputItemsItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AiJobListResDtoOutputItemsItemStatus = {
  QUEUED: 'QUEUED',
  RUNNING: 'RUNNING',
  SUCCEEDED: 'SUCCEEDED',
  FAILED: 'FAILED',
