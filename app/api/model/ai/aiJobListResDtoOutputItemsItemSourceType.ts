 ...
 */
export type AiJobListResDtoOutputItemsItemSourceType = typeof AiJobListResDtoOutputItemsItemSourceType[keyof typeof AiJobListResDtoOutputItemsItemSourceType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AiJobListResDtoOutputItemsItemSourceType = {
  ORIGINAL: 'ORIGINAL',
  COMPOSITE: 'COMPOSITE',
} as const;
