 ...
 */
import type { AiJobResDtoOutputProposedRegionsItemRegionType } from './aiJobResDtoOutputProposedRegionsItemRegionType';
import type { AiJobResDtoOutputProposedRegionsItemCoordinates } from './aiJobResDtoOutputProposedRegionsItemCoordinates';

export type AiJobResDtoOutputProposedRegionsItem = {
  /** Loại vùng trên trang: PANEL, BACKGROUND, SPEECH_BUBBLE, SFX, CHARACTER. Values: PANEL, BACKGROUND, SPEECH_BUBBLE, SFX, CHARACTER */
  regionType: AiJobResDtoOutputProposedRegionsItemRegionType;
  /** @nullable */
  detectedSubtype: string | null;
  /** Pixel bbox coordinates, top-left origin */
  coordinates: AiJobResDtoOutputProposedRegionsItemCoordinates;
  /**
   * @minimum 0
   * @maximum 1
   */
  confidenceScore: number;
  /** Whether this region type is suggested for the job source stage */
  suggestedForStage: boolean;
};
