 ...
 */
export type SegmentAcceptedResDtoOutputStatus = typeof SegmentAcceptedResDtoOutputStatus[keyof typeof SegmentAcceptedResDtoOutputStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SegmentAcceptedResDtoOutputStatus = {
  QUEUED: 'QUEUED',
  RUNNING: 'RUNNING',
  SUCCEEDED: 'SUCCEEDED',
  FAILED: 'FAILED',
