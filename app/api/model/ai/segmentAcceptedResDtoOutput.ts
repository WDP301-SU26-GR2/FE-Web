 ...
 */
import type { SegmentAcceptedResDtoOutputStatus } from './segmentAcceptedResDtoOutputStatus';

export interface SegmentAcceptedResDtoOutput {
  jobId: string;
  /** AI job lifecycle: QUEUED -> RUNNING -> SUCCEEDED | FAILED. Values: QUEUED, RUNNING, SUCCEEDED, FAILED */
  status: SegmentAcceptedResDtoOutputStatus;
}
