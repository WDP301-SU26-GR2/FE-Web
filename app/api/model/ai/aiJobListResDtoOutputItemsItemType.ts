 ...
 */
export type AiJobListResDtoOutputItemsItemType = typeof AiJobListResDtoOutputItemsItemType[keyof typeof AiJobListResDtoOutputItemsItemType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AiJobListResDtoOutputItemsItemType = {
  SEGMENT: 'SEGMENT',
  COLOR: 'COLOR',
  NUMBER: 'NUMBER',
} as const;
