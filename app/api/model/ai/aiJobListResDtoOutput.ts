 ...
 */
import type { AiJobListResDtoOutputItemsItem } from './aiJobListResDtoOutputItemsItem';

export interface AiJobListResDtoOutput {
  items: AiJobListResDtoOutputItemsItem[];
}
