 ...
 */
export type AiJobResDtoOutputSourceType = typeof AiJobResDtoOutputSourceType[keyof typeof AiJobResDtoOutputSourceType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AiJobResDtoOutputSourceType = {
  ORIGINAL: 'ORIGINAL',
  COMPOSITE: 'COMPOSITE',
} as const;
