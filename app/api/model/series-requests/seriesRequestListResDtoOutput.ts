 ...
 */
import type { SeriesRequestListResDtoOutputItemsItem } from './seriesRequestListResDtoOutputItemsItem';

export interface SeriesRequestListResDtoOutput {
  items: SeriesRequestListResDtoOutputItemsItem[];
  total: number;
  limit: number;
  offset: number;
}
