 ...
 */
export type SeriesRequestResDtoOutputStatus = typeof SeriesRequestResDtoOutputStatus[keyof typeof SeriesRequestResDtoOutputStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesRequestResDtoOutputStatus = {
  PENDING: 'PENDING',
  ACCEPTED: 'ACCEPTED',
  REJECTED: 'REJECTED',
  CANCELLED: 'CANCELLED',
