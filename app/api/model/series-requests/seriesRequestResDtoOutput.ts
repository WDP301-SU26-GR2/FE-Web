 ...
 */
import type { SeriesRequestResDtoOutputRequestType } from './seriesRequestResDtoOutputRequestType';
import type { SeriesRequestResDtoOutputStatus } from './seriesRequestResDtoOutputStatus';

export interface SeriesRequestResDtoOutput {
  id: string;
  seriesId: string;
  requestedBy: string;
  /** Allowed values: WITHDRAW, HIATUS, COMPLETION. Values: WITHDRAW, HIATUS, COMPLETION */
  requestType: SeriesRequestResDtoOutputRequestType;
  reason: string;
  /** @nullable */
  ...
  status: SeriesRequestResDtoOutputStatus;
  /** @nullable */
