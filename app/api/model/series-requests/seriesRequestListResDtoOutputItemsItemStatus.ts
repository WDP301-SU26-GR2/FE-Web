 ...
 */
export type SeriesRequestListResDtoOutputItemsItemStatus = typeof SeriesRequestListResDtoOutputItemsItemStatus[keyof typeof SeriesRequestListResDtoOutputItemsItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesRequestListResDtoOutputItemsItemStatus = {
  PENDING: 'PENDING',
  ACCEPTED: 'ACCEPTED',
  REJECTED: 'REJECTED',
  CANCELLED: 'CANCELLED',
