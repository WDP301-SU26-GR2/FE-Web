...
export type SeriesRequestControllerListStatus = typeof SeriesRequestControllerListStatus[keyof typeof SeriesRequestControllerListStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesRequestControllerListStatus = {
  PENDING: 'PENDING',
  ACCEPTED: 'ACCEPTED',
  REJECTED: 'REJECTED',
  CANCELLED: 'CANCELLED',
