 ...
 */
import type { ConfirmStageOutputsBodyDtoItemsItem } from './confirmStageOutputsBodyDtoItemsItem';

export interface ConfirmStageOutputsBodyDto {
  /**
   * @minItems 1
   * @maxItems 200
   */
  items: ConfirmStageOutputsBodyDtoItemsItem[];
}
