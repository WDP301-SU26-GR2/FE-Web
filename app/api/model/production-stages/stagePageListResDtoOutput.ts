 ...
 */
import type { StagePageListResDtoOutputItemsItem } from './stagePageListResDtoOutputItemsItem';

export interface StagePageListResDtoOutput {
  items: StagePageListResDtoOutputItemsItem[];
}
