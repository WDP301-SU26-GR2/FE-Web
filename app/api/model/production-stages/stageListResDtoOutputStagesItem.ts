 ...
 */
import type { StageListResDtoOutputStagesItemTaskTypesItem } from './stageListResDtoOutputStagesItemTaskTypesItem';
import type { StageListResDtoOutputStagesItemStatus } from './stageListResDtoOutputStagesItemStatus';
import type { StageListResDtoOutputStagesItemAnalytics } from './stageListResDtoOutputStagesItemAnalytics';

export type StageListResDtoOutputStagesItem = {
  id: string;
  chapterId: string;
  order: number;
  name: string;
  taskTypes: StageListResDtoOutputStagesItemTaskTypesItem[];
  isFinalCheck: boolean;
  /** Production stage lifecycle: LOCKED -> ACTIVE -> COMPLETED. Values: LOCKED, ACTIVE, COMPLETED */
  status: StageListResDtoOutputStagesItemStatus;
  /** @nullable */
  ...
  analytics: StageListResDtoOutputStagesItemAnalytics;
  warnings?: string[];
};
