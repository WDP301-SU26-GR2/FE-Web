 ...
 */
import type { ProductionStageResDtoOutputTaskTypesItem } from './productionStageResDtoOutputTaskTypesItem';
import type { ProductionStageResDtoOutputStatus } from './productionStageResDtoOutputStatus';
import type { ProductionStageResDtoOutputAnalytics } from './productionStageResDtoOutputAnalytics';

export interface ProductionStageResDtoOutput {
  id: string;
  chapterId: string;
  order: number;
  name: string;
  taskTypes: ProductionStageResDtoOutputTaskTypesItem[];
  isFinalCheck: boolean;
  /** Production stage lifecycle: LOCKED -> ACTIVE -> COMPLETED. Values: LOCKED, ACTIVE, COMPLETED */
  status: ProductionStageResDtoOutputStatus;
  /** @nullable */
  ...
  analytics: ProductionStageResDtoOutputAnalytics;
  warnings?: string[];
}
