 ...
 */
export type StageListResDtoOutputStagesItemStatus = typeof StageListResDtoOutputStagesItemStatus[keyof typeof StageListResDtoOutputStagesItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const StageListResDtoOutputStagesItemStatus = {
  LOCKED: 'LOCKED',
  ACTIVE: 'ACTIVE',
  COMPLETED: 'COMPLETED',
} as const;
