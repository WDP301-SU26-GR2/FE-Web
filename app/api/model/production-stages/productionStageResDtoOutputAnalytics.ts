 ...
 */
import type { ProductionStageResDtoOutputAnalyticsLongestTask } from './productionStageResDtoOutputAnalyticsLongestTask';

export type ProductionStageResDtoOutputAnalytics = {
  taskCount: number;
  ...
  /** @nullable */
  longestTask: ProductionStageResDtoOutputAnalyticsLongestTask;
};
