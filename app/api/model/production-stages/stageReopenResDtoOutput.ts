...
export interface StageReopenResDtoOutput {
  message: string;
  /** Stage vừa được mở lại, nay ở ACTIVE */
  stageId: string;
  /** Các stage phía sau đã bị đưa về LOCKED */
  relockedStageIds: string[];
  /**
   * Số ProductionStagePage của các stage phía sau đã bị xoá
   * @minimum -9007199254740991
   * @maximum 9007199254740991
   */
  clearedStagePages: number;
}
