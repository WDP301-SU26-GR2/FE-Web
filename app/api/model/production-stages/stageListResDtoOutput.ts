 ...
 */
import type { StageListResDtoOutputStagesItem } from './stageListResDtoOutputStagesItem';
import type { StageListResDtoOutputCurrentStage } from './stageListResDtoOutputCurrentStage';
import type { StageListResDtoOutputBottleneckStage } from './stageListResDtoOutputBottleneckStage';

export interface StageListResDtoOutput {
  stages: StageListResDtoOutputStagesItem[];
  /** @nullable */
  currentStage: StageListResDtoOutputCurrentStage;
  /** @nullable */
  bottleneckStage: StageListResDtoOutputBottleneckStage;
}
