 ...
 */
export type ProductionStageResDtoOutputStatus = typeof ProductionStageResDtoOutputStatus[keyof typeof ProductionStageResDtoOutputStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProductionStageResDtoOutputStatus = {
  LOCKED: 'LOCKED',
  ACTIVE: 'ACTIVE',
  COMPLETED: 'COMPLETED',
} as const;
