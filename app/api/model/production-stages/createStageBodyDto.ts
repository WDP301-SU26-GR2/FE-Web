 ...
 */
import type { CreateStageBodyDtoTaskTypesItem } from './createStageBodyDtoTaskTypesItem';

export interface CreateStageBodyDto {
  /**
   * @minLength 1
   * @maxLength 120
   */
  name: string;
  taskTypes?: CreateStageBodyDtoTaskTypesItem[];
  /**
