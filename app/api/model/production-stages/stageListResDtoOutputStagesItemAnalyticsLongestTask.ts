 ...
 */
import type { StageListResDtoOutputStagesItemAnalyticsLongestTaskTaskType } from './stageListResDtoOutputStagesItemAnalyticsLongestTaskTaskType';

/**
 * @nullable
 */
export type StageListResDtoOutputStagesItemAnalyticsLongestTask = {
  taskId: string;
  /**
   * Assistant specialization/task type. Values: BACKGROUND, SCREENTONE, EFFECT_LINES, INKING, COLORING, LETTERING
   * @nullable
   */
  taskType: StageListResDtoOutputStagesItemAnalyticsLongestTaskTaskType;
  /** @nullable */
