 ...
 */
import type { StageListResDtoOutputStagesItemAnalyticsLongestTask } from './stageListResDtoOutputStagesItemAnalyticsLongestTask';

export type StageListResDtoOutputStagesItemAnalytics = {
  taskCount: number;
  ...
  /** @nullable */
  longestTask: StageListResDtoOutputStagesItemAnalyticsLongestTask;
};
