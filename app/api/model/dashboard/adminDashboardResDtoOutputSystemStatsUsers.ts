 ...
 */
import type { AdminDashboardResDtoOutputSystemStatsUsersByStatus } from './adminDashboardResDtoOutputSystemStatsUsersByStatus';
import type { AdminDashboardResDtoOutputSystemStatsUsersByRole } from './adminDashboardResDtoOutputSystemStatsUsersByRole';

export type AdminDashboardResDtoOutputSystemStatsUsers = {
  /** Users not soft-deleted */
  total: number;
  /** Soft-deleted users */
  deleted: number;
  byStatus: AdminDashboardResDtoOutputSystemStatsUsersByStatus;
  byRole: AdminDashboardResDtoOutputSystemStatsUsersByRole;
};
