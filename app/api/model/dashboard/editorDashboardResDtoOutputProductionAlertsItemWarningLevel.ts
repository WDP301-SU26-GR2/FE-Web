 ...
 */
export type EditorDashboardResDtoOutputProductionAlertsItemWarningLevel = typeof EditorDashboardResDtoOutputProductionAlertsItemWarningLevel[keyof typeof EditorDashboardResDtoOutputProductionAlertsItemWarningLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EditorDashboardResDtoOutputProductionAlertsItemWarningLevel = {
  NONE: 'NONE',
  YELLOW: 'YELLOW',
  RED: 'RED',
  CRITICAL: 'CRITICAL',
