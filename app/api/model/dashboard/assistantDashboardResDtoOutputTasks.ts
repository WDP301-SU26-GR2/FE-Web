 ...
 */
import type { AssistantDashboardResDtoOutputTasksByStatus } from './assistantDashboardResDtoOutputTasksByStatus';

export type AssistantDashboardResDtoOutputTasks = {
  byStatus: AssistantDashboardResDtoOutputTasksByStatus;
  openTotal: number;
};
