 ...
 */
import type { EditorDashboardResDtoOutputMySeriesByStatus } from './editorDashboardResDtoOutputMySeriesByStatus';

export type EditorDashboardResDtoOutputMySeries = {
  byStatus: EditorDashboardResDtoOutputMySeriesByStatus;
  total: number;
};
