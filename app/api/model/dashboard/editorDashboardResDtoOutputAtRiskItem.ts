 ...
 */
import type { EditorDashboardResDtoOutputAtRiskItemRiskLevel } from './editorDashboardResDtoOutputAtRiskItemRiskLevel';

export type EditorDashboardResDtoOutputAtRiskItem = {
  /** Series ObjectId */
  seriesId: string;
  title: string;
  ...
  riskLevel: EditorDashboardResDtoOutputAtRiskItemRiskLevel;
  /**
   * null nếu kỳ ranking gần nhất chưa xếp hạng series
   * @nullable
   */
