 ...
 */
import type { EditorDashboardResDtoOutputProductionAlertsItemManuscriptStatus } from './editorDashboardResDtoOutputProductionAlertsItemManuscriptStatus';
import type { EditorDashboardResDtoOutputProductionAlertsItemWarningLevel } from './editorDashboardResDtoOutputProductionAlertsItemWarningLevel';

export type EditorDashboardResDtoOutputProductionAlertsItem = {
  chapterId: string;
  seriesId: string;
  seriesTitle: string;
  ...
  warningLevel: EditorDashboardResDtoOutputProductionAlertsItemWarningLevel;
  onHold: boolean;
