 ...
 */
import type { AdminDashboardResDtoOutputSystemStats } from './adminDashboardResDtoOutputSystemStats';

export interface AdminDashboardResDtoOutput {
  systemStats: AdminDashboardResDtoOutputSystemStats;
