 ...
 */
import type { EditorDashboardResDtoOutputPendingContractsItemStatus } from './editorDashboardResDtoOutputPendingContractsItemStatus';

export type EditorDashboardResDtoOutputPendingContractsItem = {
  /** Contract ObjectId */
  contractId: string;
