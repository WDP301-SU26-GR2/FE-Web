 ...
 */
export type EditorDashboardResDtoOutputAtRiskItemRiskLevel = typeof EditorDashboardResDtoOutputAtRiskItemRiskLevel[keyof typeof EditorDashboardResDtoOutputAtRiskItemRiskLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EditorDashboardResDtoOutputAtRiskItemRiskLevel = {
  NONE: 'NONE',
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  SEVERE: 'SEVERE',
