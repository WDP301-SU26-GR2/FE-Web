 ...
 * @nullable
 */
export type EditorDashboardResDtoOutputProductionAlertsItemManuscriptStatus = typeof EditorDashboardResDtoOutputProductionAlertsItemManuscriptStatus[keyof typeof EditorDashboardResDtoOutputProductionAlertsItemManuscriptStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EditorDashboardResDtoOutputProductionAlertsItemManuscriptStatus = {
  DRAFT: 'DRAFT',
  IN_PRODUCTION: 'IN_PRODUCTION',
  EDITOR_REVIEW: 'EDITOR_REVIEW',
  EDITOR_REVISION: 'EDITOR_REVISION',
  READY_FOR_PRINT: 'READY_FOR_PRINT',
  AWAITING_CO_OWNER_APPROVAL: 'AWAITING_CO_OWNER_APPROVAL',
  PUBLISHED: 'PUBLISHED',
} as const;
