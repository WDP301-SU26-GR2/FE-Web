 ...
 */
export type MangakaEarningsResDtoOutputRecentItemStatus = typeof MangakaEarningsResDtoOutputRecentItemStatus[keyof typeof MangakaEarningsResDtoOutputRecentItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MangakaEarningsResDtoOutputRecentItemStatus = {
  TRIGGERED: 'TRIGGERED',
  MISSED: 'MISSED',
  PENDING: 'PENDING',
  APPROVED: 'APPROVED',
