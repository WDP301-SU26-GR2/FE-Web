 ...
 */
import type { AdminDashboardResDtoOutputSystemStatsSeriesByStatus } from './adminDashboardResDtoOutputSystemStatsSeriesByStatus';

export type AdminDashboardResDtoOutputSystemStatsSeries = {
  total: number;
  byStatus: AdminDashboardResDtoOutputSystemStatsSeriesByStatus;
};
