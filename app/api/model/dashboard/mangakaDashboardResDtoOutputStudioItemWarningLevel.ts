 ...
 */
export type MangakaDashboardResDtoOutputStudioItemWarningLevel = typeof MangakaDashboardResDtoOutputStudioItemWarningLevel[keyof typeof MangakaDashboardResDtoOutputStudioItemWarningLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MangakaDashboardResDtoOutputStudioItemWarningLevel = {
  NONE: 'NONE',
  YELLOW: 'YELLOW',
  RED: 'RED',
  CRITICAL: 'CRITICAL',
