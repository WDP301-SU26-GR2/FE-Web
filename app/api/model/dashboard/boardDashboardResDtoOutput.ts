 ...
 */
import type { BoardDashboardResDtoOutputPendingDecisionsItem } from './boardDashboardResDtoOutputPendingDecisionsItem';
import type { BoardDashboardResDtoOutputAtRiskSevereItem } from './boardDashboardResDtoOutputAtRiskSevereItem';

export interface BoardDashboardResDtoOutput {
  pendingDecisions: BoardDashboardResDtoOutputPendingDecisionsItem[];
  upcomingSessions: number;
  atRiskSevere: BoardDashboardResDtoOutputAtRiskSevereItem[];
