 ...
 */
import type { AdminDashboardResDtoOutputSystemStatsUsers } from './adminDashboardResDtoOutputSystemStatsUsers';
import type { AdminDashboardResDtoOutputSystemStatsSeries } from './adminDashboardResDtoOutputSystemStatsSeries';
import type { AdminDashboardResDtoOutputSystemStatsChapters } from './adminDashboardResDtoOutputSystemStatsChapters';
import type { AdminDashboardResDtoOutputSystemStatsTasks } from './adminDashboardResDtoOutputSystemStatsTasks';

export type AdminDashboardResDtoOutputSystemStats = {
  users: AdminDashboardResDtoOutputSystemStatsUsers;
  series: AdminDashboardResDtoOutputSystemStatsSeries;
  chapters: AdminDashboardResDtoOutputSystemStatsChapters;
  tasks: AdminDashboardResDtoOutputSystemStatsTasks;
};
