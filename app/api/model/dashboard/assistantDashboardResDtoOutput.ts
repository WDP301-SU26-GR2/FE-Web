 ...
 */
import type { AssistantDashboardResDtoOutputTasks } from './assistantDashboardResDtoOutputTasks';
import type { AssistantDashboardResDtoOutputReputation } from './assistantDashboardResDtoOutputReputation';

export interface AssistantDashboardResDtoOutput {
  tasks: AssistantDashboardResDtoOutputTasks;
  activeAssignments: number;
  reputation: AssistantDashboardResDtoOutputReputation;
