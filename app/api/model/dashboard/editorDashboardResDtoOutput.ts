 ...
 */
import type { EditorDashboardResDtoOutputMySeries } from './editorDashboardResDtoOutputMySeries';
import type { EditorDashboardResDtoOutputAtRiskItem } from './editorDashboardResDtoOutputAtRiskItem';
import type { EditorDashboardResDtoOutputProductionAlertsItem } from './editorDashboardResDtoOutputProductionAlertsItem';
import type { EditorDashboardResDtoOutputPendingContractsItem } from './editorDashboardResDtoOutputPendingContractsItem';

export interface EditorDashboardResDtoOutput {
  reviewQueue: number;
  mySeries: EditorDashboardResDtoOutputMySeries;
  atRisk: EditorDashboardResDtoOutputAtRiskItem[];
  productionAlerts: EditorDashboardResDtoOutputProductionAlertsItem[];
  pendingContracts: EditorDashboardResDtoOutputPendingContractsItem[];
