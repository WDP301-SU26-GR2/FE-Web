 ...
 */
import type { AdminDashboardResDtoOutputSystemStatsTasksByStatus } from './adminDashboardResDtoOutputSystemStatsTasksByStatus';

export type AdminDashboardResDtoOutputSystemStatsTasks = {
  total: number;
  byStatus: AdminDashboardResDtoOutputSystemStatsTasksByStatus;
};
