 ...
 */
import type { MangakaDashboardResDtoOutputStudioItem } from './mangakaDashboardResDtoOutputStudioItem';
import type { MangakaDashboardResDtoOutputRankingsItem } from './mangakaDashboardResDtoOutputRankingsItem';

export interface MangakaDashboardResDtoOutput {
  /** Chapter đang sản xuất, sắp theo mức cảnh báo deadline */
  studio: MangakaDashboardResDtoOutputStudioItem[];
  /** Ranking kỳ gần nhất của từng series thuộc Mangaka */
  rankings: MangakaDashboardResDtoOutputRankingsItem[];
  /** Số thông báo chưa đọc (badge) */
  unreadNotifications: number;
  /** Số vòng yêu cầu sửa còn mở mà Mangaka phải xử lý */
