 ...
 */
import type { MangakaEarningsResDtoOutputByStatus } from './mangakaEarningsResDtoOutputByStatus';
import type { MangakaEarningsResDtoOutputByType } from './mangakaEarningsResDtoOutputByType';
import type { MangakaEarningsResDtoOutputRecentItem } from './mangakaEarningsResDtoOutputRecentItem';

export interface MangakaEarningsResDtoOutput {
  totalPaid: number;
  totalPending: number;
  totalMissed: number;
  byStatus: MangakaEarningsResDtoOutputByStatus;
  byType: MangakaEarningsResDtoOutputByType;
  recent: MangakaEarningsResDtoOutputRecentItem[];
}
