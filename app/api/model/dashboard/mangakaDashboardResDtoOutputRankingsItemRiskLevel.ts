 ...
 */
export type MangakaDashboardResDtoOutputRankingsItemRiskLevel = typeof MangakaDashboardResDtoOutputRankingsItemRiskLevel[keyof typeof MangakaDashboardResDtoOutputRankingsItemRiskLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MangakaDashboardResDtoOutputRankingsItemRiskLevel = {
  NONE: 'NONE',
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  SEVERE: 'SEVERE',
