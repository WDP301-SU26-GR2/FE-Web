...
/**
 * @summary Mangaka tạo Chapter (chapter-first): chapterNumber + title → Chapter(DRAFT) + Manuscript(DRAFT) + Schedule. Storyboard tạo sau qua POST /chapters/:id/storyboards.
 */
...
export const chapterControllerCoOwnerReject = async ({ id }: ChapterControllerCoOwnerRejectPathParameters,
    chapterReasonBodyDto: ChapterReasonBodyDto, options?: RequestInit): Promise<chapterControllerCoOwnerRejectResponse> => {
