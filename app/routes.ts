...
export default [
  ...
  ...prefix('dashboard/admin', [
    layout('routes/admin/_layout.tsx', [
      ...
      route('board', 'routes/admin/board.tsx'),
      route('board/sessions', 'routes/admin/board-sessions.tsx'),
      route('board/sessions/:id', 'routes/admin/board-session-detail.tsx'),
      route('board/decisions', 'routes/admin/board-decisions.tsx'),
      route('board/decisions/:id', 'routes/admin/board-decision-detail.tsx'),
      route('board/lifecycle', 'routes/admin/board-lifecycle.tsx'),
      route('board/reports', 'routes/admin/board-reports.tsx'),
